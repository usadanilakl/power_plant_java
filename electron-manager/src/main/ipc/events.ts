...
export const IPC_SDS_SYNC_PDFS = 'sds-scrape:sync-pdfs';
...
export const IPC_WEATHER_GET_ENABLED = 'weather:get-enabled';   // WeatherBug lightning scraper, per machine
export const IPC_WEATHER_SET_ENABLED = 'weather:set-enabled';
