...
var FormRenderingService = class _FormRenderingService {
  ...
  addControlByPath(form, path, control) {
    ...
    for (let i = 0; i < parts.length - 1; i++) {
      ...
      if (!child || !(child instanceof FormGroup)) {
        child = new FormGroup({});
        current.addControl(parts[i], child);
      }
      current = child;
    }
...
function FormContainerRendererComponent_Conditional_1_Case_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-invisible-input-field", 14);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275styleMap(ctx_r0.asFormField(ctx_r0.container().content).style);
...
function FormContainerRendererComponent_Conditional_1_Case_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-invisible-searchable-select", 15);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275styleMap(ctx_r0.asFormField(ctx_r0.container().content).style);
...
function FormContainerRendererComponent_Conditional_1_Case_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-invisible-searchable-multi-select", 15);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275styleMap(ctx_r0.asFormField(ctx_r0.container().content).style);
...
function FormContainerRendererComponent_Conditional_1_Case_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-nested-form-input", 17);
...
function FormContainerRendererComponent_Conditional_1_Case_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-work-area-select", 18);
  }
  if (rf & 2) {
    let tmp_5_0;
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275styleMap(ctx_r0.asFormField(ctx_r0.container().content).style);
    \u0275\u0275property("formControl", ctx_r0.getFormControl(ctx_r0.asFormField(ctx_r0.container().content).name))("viewMode", "both")("fallbackText", (tmp_5_0 = (tmp_5_0 = ctx_r0.asFormField(ctx_r0.container().content).context) == null ? null : tmp_5_0["fallbackText"]) !== null && tmp_5_0 !== void 0 ? tmp_5_0 : null);
  }
}
function FormContainerRendererComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, FormContainerRendererComponent_Conditional_1_Case_0_Template, 1, 3, "app-invisible-input-field", 2)(1, FormContainerRendererComponent_Conditional_1_Case_1_Template, 1, 3, "app-invisible-input-field", 3)(2, FormContainerRendererComponent_Conditional_1_Case_2_Template, 1, 3, "app-invisible-input-field", 4)(3, FormContainerRendererComponent_Conditional_1_Case_3_Template, 1, 3, "app-invisible-input-field", 5)(4, FormContainerRendererComponent_Conditional_1_Case_4_Template, 1, 5, "app-invisible-searchable-select", 6)(5, FormContainerRendererComponent_Conditional_1_Case_5_Template, 1, 5, "app-invisible-searchable-multi-select", 6)(6, FormContainerRendererComponent_Conditional_1_Case_6_Template, 1, 4, "app-checkbox-x", 7)(7, FormContainerRendererComponent_Conditional_1_Case_7_Template, 1, 4, "app-radio-checkboxes", 8)(8, FormContainerRendererComponent_Conditional_1_Case_8_Template, 1, 4, "app-nested-form-input", 9)(9, FormContainerRendererComponent_Conditional_1_Case_9_Template, 1, 5, "app-work-area-select", 10);
  }
  if (rf & 2) {
    let tmp_1_0;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275conditional((tmp_1_0 = ctx_r0.asFormField(ctx_r0.container().content).type) === "text" ? 0 : tmp_1_0 === "textarea" ? 1 : tmp_1_0 === "number" ? 2 : tmp_1_0 === "date" ? 3 : tmp_1_0 === "select" ? 4 : tmp_1_0 === "multi-select" ? 5 : tmp_1_0 === "checkbox" ? 6 : tmp_1_0 === "radio" ? 7 : tmp_1_0 === "form-array" ? 8 : tmp_1_0 === "work-area-select" ? 9 : -1);
  }
}
...
var FormContainerRendererComponent = class _FormContainerRendererComponent {
  ...
  getContainerStyles(container) {
    ...
    if (this.isFormField(container.content) && container.content.type === "work-area-select") {
      styles["overflow"] = "visible";
      styles["z-index"] = "100";
    }
    return styles;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FormContainerRendererComponent, selectors: [["app-form-container-renderer"]], inputs: { container: [1, "container"], form: [1, "form"], readOnly: [1, "readOnly"], formData: [1, "formData"] }, outputs: { arrayItemAdded: "arrayItemAdded", arrayItemRemoved: "arrayItemRemoved" }, decls: 4, vars: 2, consts: [[1, "form-container", 3, "ngStyle"], [1, "content-display", 3, "ngStyle"], ["type", "text", 3, "formControl", "style"], ["type", "textarea", 3, "formControl", "style"], ["type", "number", 3, "formControl", "style"], ["type", "date", 3, "formControl", "style"], [3, "formControl", "options", "style"], [3, "formControl", "id", "style"], [3, "formControl", "name", "options"], [3, "formField", "formArray", "fieldName", "arrayIndexRange"], [3, "formControl", "viewMode", "fallbackText", "style"], ["type", "text", 3, "formControl"], ["type", "textarea", 3, "formControl"], ["type", "number", 3, "formControl"], ["type", "date", 3, "formControl"], [3, "formControl", "options"], [3, "formControl", "id"], [3, "itemAdded", "itemRemoved", "formField", "formArray", "fieldName", "arrayIndexRange"], [3, "formControl", "viewMode", "fallbackText"]], template: function FormContainerRendererComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275template(1, FormContainerRendererComponent_Conditional_1_Template, 10, 1)(2, FormContainerRendererComponent_Conditional_2_Template, 2, 2, "div", 1)(3, FormContainerRendererComponent_Conditional_3_Template, 2, 2, "div", 1);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FormContainerRendererComponent, { className: "FormContainerRendererComponent", filePath: "src/app/features/form-designer-refactored/form-renderer/form-container-renderer/form-container-renderer.component.ts", lineNumber: 32 });
})();
  ...
  printForm(definition, data) {
    ...
    setTimeout(() => {
      ...
      if (electronAPI?.printWithPreview) {
        electronAPI.printWithPreview().then(() => this.printableForm.set(null)).catch(() => this.printableForm.set(null));
...
//# sourceMappingURL=chunk-74NDDOPI.js.map
