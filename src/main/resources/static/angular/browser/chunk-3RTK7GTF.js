...
var ChekcboxGroupComponent = class _ChekcboxGroupComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ChekcboxGroupComponent, selectors: [["app-chekcbox-group"]], inputs: { label: "label", options: "options" }, features: [\u0275\u0275ProvidersFeature([
    ...
    if (rf & 1) {
      ...
      \u0275\u0275text(3);
      \u0275\u0275elementEnd()();
      \u0275\u0275repeaterCreate(4, ChekcboxGroupComponent_For_5_Template, 2, 1, null, null, _forTrack0);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
...
var RfRadioGroupComponent = class _RfRadioGroupComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RfRadioGroupComponent, selectors: [["app-rf-radio-group"]], inputs: { label: "label", options: "options", name: "name" }, features: [\u0275\u0275ProvidersFeature([
    ...
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(4, RfRadioGroupComponent_For_5_Template, 4, 6, "div", 3, _forTrack02);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
...
function SearchableMultiSelectInputComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
var SearchableMultiSelectInputComponent = class _SearchableMultiSelectInputComponent {
  ...
  ])], decls: 8, vars: 6, consts: [[1, "multi-select-container"], [1, "selected-options"], [1, "selected-option"], [1, "selected-placeholder"], [3, "editOption", "addNewOption", "valueChange", "label", "options", "categoryName", "closeOnSelect"], ["type", "button", 3, "click"]], template: function SearchableMultiSelectInputComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(6, SearchableMultiSelectInputComponent_Conditional_6_Template, 2, 0, "div", 3);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "app-searchable-select-input", 4);
      \u0275\u0275listener("editOption", function SearchableMultiSelectInputComponent_Template_app_searchable_select_input_editOption_7_listener() {
        return ctx.onEditOption();
      })("addNewOption", function SearchableMultiSelectInputComponent_Template_app_searchable_select_input_addNewOption_7_listener() {
        return ctx.onAddNewOption();
      })("valueChange", function SearchableMultiSelectInputComponent_Template_app_searchable_select_input_valueChange_7_listener($event) {
...
var RfLotoPointApiService = class _RfLotoPointApiService {
  ...
  setModelFileOnPoints(lotoPointIds, modelFileId) {
    return this.http.put(`${this.apiUrl}/set-model-file`, { lotoPointIds, modelFileId });
  }
  /** LOTO points linked to a given 3D model file (FileObject ID). */
  getByModelFile(fileId) {
    return this.http.get(`${this.apiUrl}/by-model-file/${fileId}`);
  }
  /** Find-or-create a Value by category and name. Used for reference data setup. */
  createValue(category, value) {
    return this.http.post(`${environment.apiUrl}/values/${encodeURIComponent(category)}/${encodeURIComponent(value)}`, {});
  }
...
// src/app/features/files/refactored/services/rf-file-api.service.ts
var RfFileApiService = class _RfFileApiService {
  http;
  apiUrl = `${environment.apiUrl}/files`;
  constructor(http) {
    this.http = http;
  ...
  getRelatedLotoPoints(fileId) {
    return this.http.get(`${this.apiUrl}/${fileId}/related-loto-points`);
  }
  getUniqueValuesOfColumn(column) {
    return this.http.get(`${this.apiUrl}/unique-values/${column}`);
  }
  getFilteredUniqueValuesOfColumn(column, searchCriteria, page = 1, pageSize = 50, andLogicEnabled = true) {
    const params = new HttpParams().set("page", page.toString()).set("pageSize", pageSize.toString()).set("andLogicEnabled", andLogicEnabled.toString());
    return this.http.post(`${this.apiUrl}/unique-values/${column}/filtered`, searchCriteria, { params });
  }
  uploadFile(formData) {
    return this.http.put(this.apiUrl, formData);
  }
   ...
   */
  uploadMultipleFiles(files, fileTypeId, vendorId, sharedFileName) {
    const formData = new FormData();
    files.forEach((file) => {
      formData.append("files", file);
    });
    let params = new HttpParams().set("fileTypeId", fileTypeId.toString()).set("vendorId", vendorId.toString());
    if (sharedFileName && sharedFileName.trim()) {
      params = params.set("sharedFileName", sharedFileName.trim());
    }
    return this.http.post(`${this.apiUrl}/multi-upload`, formData, { params });
  }
  static \u0275fac = function RfFileApiService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _RfFileApiService)(\u0275\u0275inject(HttpClient));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _RfFileApiService, factory: _RfFileApiService.\u0275fac, providedIn: "root" });
};
...
var AuthService = class _AuthService {
  http;
  router;
  authUrl = `${environment.baseApiUrl}/api/auth`;
  currentUserSubject = new BehaviorSubject(null);
  isLoggedInSubject = new BehaviorSubject(false);
  authCheckedSubject = new BehaviorSubject(false);
  ...
  login(credential, password) {
    return this.http.post(`${this.authUrl}/login`, { credential, password }, { withCredentials: true }).pipe(tap((user) => {
      this.currentUserSubject.next(user);
      this.isLoggedInSubject.next(true);
    }));
  }
  logout() {
    return this.http.post(`${this.authUrl}/logout`, {}, { withCredentials: true }).pipe(tap(() => {
  ...
  checkAuthStatus() {
    this.http.get(`${this.authUrl}/me`, { withCredentials: true }).pipe(catchError(() => {
      this.currentUserSubject.next(null);
      this.isLoggedInSubject.next(false);
      return of(null);
    })).subscribe((user) => {
  ...
  requestAccess() {
    return this.http.post(`${this.authUrl}/request-access`, {}, { withCredentials: true });
  }
  getAccessStatus() {
    return this.http.get(`${this.authUrl}/access-status`, { withCredentials: true });
  }
  getProfile() {
    return this.http.get(`${this.authUrl}/profile`, { withCredentials: true });
  }
  updateProfile(data) {
    return this.http.put(`${this.authUrl}/profile`, data, { withCredentials: true }).pipe(tap(() => {
      this.checkAuthStatus();
    }));
  }
  getMyAccessGrants() {
    return this.http.get(`${this.authUrl}/profile/sessions`, { withCredentials: true });
  }
  changePasswordVerified(req) {
...
var SyncUpdateService = class _SyncUpdateService {
  ...
  syncActivitySubject = new Subject();
  ...
  constructor() {
    if (isPlatformBrowser(this.platformId)) {
      combineLatest([this.authService.authChecked$, this.authService.isLoggedIn$]).pipe(takeUntilDestroyed(this.destroyRef)).subscribe(([checked, isLoggedIn]) => {
        if (!checked) {
          return;
        }
        if (isLoggedIn) {
...
var CurrentFileService = class _CurrentFileService {
  ...
  fileApiService = inject(RfFileApiService);
   ...
   */
  fileTypesSubject = new BehaviorSubject([]);
  ...
  constructor() {
    ...
    this.syncUpdateService.getEntityTypeUpdates$("FileObject").pipe(takeUntilDestroyed(this.destroyRef)).subscribe(() => this.loadDistinctFileTypes());
  ...
  loadDistinctFileTypes() {
    this.fileApiService.getDistinctFileTypes().pipe(takeUntilDestroyed(this.destroyRef), map((res) => res.responseData ?? [])).subscribe((types) => {
      const current = this.fileTypesSubject.getValue();
      const changed = types.length !== current.length || types.some((t, i) => t !== current[i]);
  ...
  loadAllFilesByType() {
    ...
    if (types.length === 0) {
      this.fileMapByTypeSubject.next(/* @__PURE__ */ new Map());
      this.filesLoadedSubject.next(true);
      return;
    }
    const fileObservables = types.map((type) => this.fileService.getByFileType(type).pipe(map((response) => ({ type, files: response.responseData }))));
...
function SymbolPaletteComponent_For_2_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, SymbolPaletteComponent_For_2_Conditional_6_For_2_Template, 5, 5, "div", 8, _forTrack03);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var SymbolPaletteComponent = class _SymbolPaletteComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SymbolPaletteComponent, selectors: [["app-symbol-palette"]], outputs: { symbolSelected: "symbolSelected" }, decls: 3, vars: 0, consts: [[1, "symbol-palette"], [1, "symbol-category", 3, "expanded"], [1, "symbol-category"], [1, "category-header", 3, "click"], [1, "category-label"], ["width", "12", "height", "12", "viewBox", "0 0 16 16", "fill", "currentColor", 1, "chevron"], ["fill-rule", "evenodd", "d", "M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 0 1 0-.708z"], [1, "symbol-grid"], [1, "symbol-item", 3, "title"], [1, "symbol-item", 3, "click", "title"], [1, "symbol-svg"], ["fill", "none"]], template: function SymbolPaletteComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275repeaterCreate(1, SymbolPaletteComponent_For_2_Template, 7, 6, "div", 1, _forTrack03);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
function UnifiedToolbarComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2);
    \u0275\u0275repeaterCreate(1, UnifiedToolbarComponent_Conditional_2_For_2_Template, 5, 5, "button", 3, _forTrack04);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function UnifiedToolbarComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, UnifiedToolbarComponent_Conditional_3_For_3_Template, 5, 5, "button", 3, _forTrack04);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function UnifiedToolbarComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 7);
    \u0275\u0275elementStart(1, "div", 2);
    \u0275\u0275repeaterCreate(2, UnifiedToolbarComponent_Conditional_4_For_3_Template, 5, 5, "button", 3, _forTrack04);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function UnifiedToolbarComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 7);
    \u0275\u0275elementStart(1, "div", 2);
    \u0275\u0275repeaterCreate(2, UnifiedToolbarComponent_Conditional_5_For_3_Template, 5, 5, "button", 3, _forTrack04);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var InteractiveImageComponent = class _InteractiveImageComponent {
  ...
  onTouchStart(event) {
    ...
    if (event.touches.length === 1) {
      ...
      this.touchState.startTransform = __spreadValues({}, this.transformState);
  ...
  onTouchMove(event) {
    ...
    if (event.touches.length === 1 && this.touchState.isPanning) {
      ...
      const newPosition = this.zoomPanService.calculatePan(this.touchState.startPos, { x: touch.clientX, y: touch.clientY }, this.touchState.startTransform);
      this.transformState = __spreadProps(__spreadValues({}, this.transformState), {
        pointX: newPosition.pointX,
        pointY: newPosition.pointY
      });
  ...
  isOverShapeAtPoint(clientX, clientY) {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InteractiveImageComponent, selectors: [["app-interactive-image"]], viewQuery: function InteractiveImageComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      })("touchstart", function InteractiveImageComponent_Template_img_touchstart_9_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onTouchStart($event));
      })("touchmove", function InteractiveImageComponent_Template_img_touchmove_9_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onTouchMove($event));
      })("touchend", function InteractiveImageComponent_Template_img_touchend_9_listener($event) {
        \u0275\u0275restoreView(_r1);
...
function EquipmentBrowserDialogComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(5, EquipmentBrowserDialogComponent_Conditional_13_For_6_Template, 2, 2, "option", 14, _forTrack05);
    \u0275\u0275elementEnd()();
...
var RfValueService = class _RfValueService {
  ...
  constructor() {
    ...
    authService.currentUser$.pipe(filter((user) => user != null && user.accessLevel === "FULL"), take(1), takeUntilDestroyed(this.destroyRef)).subscribe(() => {
      this.loadCategories();
...
function EquipmentUnifiedDialogComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(22, "-- Select --");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(23, EquipmentUnifiedDialogComponent_Conditional_10_For_24_Template, 2, 2, "option", 23, _forTrack06);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(30, "-- Select --");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(31, EquipmentUnifiedDialogComponent_Conditional_10_For_32_Template, 2, 2, "option", 23, _forTrack06);
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275text(39, "-- Select --");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(40, EquipmentUnifiedDialogComponent_Conditional_10_For_41_Template, 2, 2, "option", 23, _forTrack06);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(47, "-- Select --");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(48, EquipmentUnifiedDialogComponent_Conditional_10_For_49_Template, 2, 2, "option", 23, _forTrack06);
    \u0275\u0275elementEnd()()();
...
function RfEquipmentEditorComponent_Conditional_3_Conditional_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("imageUrl", ctx_r0.fileLink())("shapesInput", ctx_r0.shapes())("focusShapeId", ctx_r0.selectedEquipmentId())("preset", "EQUIPMENT_EDITOR");
  }
}
...
function RfEquipmentEditorComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(7, RfEquipmentEditorComponent_Conditional_3_Conditional_7_Template, 1, 4, "app-interactive-image", 11)(8, RfEquipmentEditorComponent_Conditional_3_Conditional_8_Template, 3, 0, "div", 12);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_1_0;
...
var RfEquipmentEditorComponent = class _RfEquipmentEditorComponent {
  ...
  ])], decls: 4, vars: 3, consts: [[1, "equipment-editor-container"], [1, "loading-overlay"], [1, "error-message"], [1, "editor-content"], [1, "spinner"], [1, "error-icon"], [1, "editor-header"], [1, "equipment-info"], [1, "header-actions"], [1, "btn", "btn-primary", 3, "click", "disabled"], [1, "image-container"], [3, "imageUrl", "shapesInput", "focusShapeId", "preset"], [1, "no-file-message"], [1, "equipment-name"], [3, "shapeClicked", "shapeRightClicked", "shapeUpdated", "imageUrl", "shapesInput", "focusShapeId", "preset"]], template: function RfEquipmentEditorComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
...
function EquipmentConflictDialogComponent_Conditional_1_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, EquipmentConflictDialogComponent_Conditional_1_Conditional_17_For_5_Template, 6, 3, "div", 16, _forTrack07);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
var EquipmentListManagerComponent = class _EquipmentListManagerComponent {
  ...
  loadLotoPointFormComponent() {
    return __async(this, null, function* () {
      ...
      const { RfReactiveFormComponent: RfReactiveFormComponent2 } = yield import("./chunk-3MV6KCRF.js");
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EquipmentListManagerComponent, selectors: [["app-equipment-list-manager"]], viewQuery: function EquipmentListManagerComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(17, "app-rf-popup-projection", 9);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("isOpen", ctx.isVeiewerOpen())("title", "Viewing File")("size", "large")("fullHeight", true)("zIndex", 10050);
      \u0275\u0275advance();
      \u0275\u0275property("selectedEquipmentId", (tmp_26_0 = ctx.selectedEquipment()) == null ? null : tmp_26_0.id);
      \u0275\u0275advance();
...
function RfValueSelectComponent_Conditional_5_Conditional_5_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(6, RfValueSelectComponent_Conditional_5_Conditional_5_Conditional_2_For_7_Template, 2, 2, "option", 18, _forTrack08);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
...
function ZeroEnergyPhraseBuilderComponent_Conditional_17_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(6, ZeroEnergyPhraseBuilderComponent_Conditional_17_Conditional_15_For_7_Template, 2, 2, "option", 54, _forTrack09);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
// src/app/shared/reactive-form/refactored/input-fields/characteristics-editor/characteristics-editor.component.ts
function CharacteristicsEditorComponent_For_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 3)(1, "app-rf-value-select", 5);
    \u0275\u0275listener("valueSelected", function CharacteristicsEditorComponent_For_5_Template_app_rf_value_select_valueSelected_1_listener($event) {
      const $index_r2 = \u0275\u0275restoreView(_r1).$index;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onCharacteristicSelected($index_r2, $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "input", 6);
    \u0275\u0275listener("input", function CharacteristicsEditorComponent_For_5_Template_input_input_2_listener($event) {
      const $index_r2 = \u0275\u0275restoreView(_r1).$index;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onValueChanged($index_r2, $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 7);
    \u0275\u0275listener("click", function CharacteristicsEditorComponent_For_5_Template_button_click_3_listener() {
      const $index_r2 = \u0275\u0275restoreView(_r1).$index;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.removeCharacteristic($index_r2));
    });
    \u0275\u0275text(4, "\u2715");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("categoryAlias", ctx_r2.categoryAlias)("label", "")("canManageValues", true)("ngModel", char_r4.characteristicId);
    \u0275\u0275advance();
    \u0275\u0275property("value", char_r4.value);
  }
}
var CharacteristicsEditorComponent = class _CharacteristicsEditorComponent {
  label = "Characteristics";
  categoryAlias = "equipmentCharacteristic";
  ...
  onCharacteristicSelected(index, valueDto) {
    const current = [...this.characteristics()];
    if (current[index]) {
  ...
  static \u0275fac = function CharacteristicsEditorComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CharacteristicsEditorComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CharacteristicsEditorComponent, selectors: [["app-characteristics-editor"]], inputs: { label: "label", categoryAlias: "categoryAlias" }, features: [\u0275\u0275ProvidersFeature([
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => _CharacteristicsEditorComponent),
      multi: true
    }
  ])], decls: 8, vars: 1, consts: [[1, "characteristics-editor"], [1, "editor-label"], [1, "char-list"], [1, "char-row"], ["type", "button", 1, "char-add-btn", 3, "click"], [3, "valueSelected", "categoryAlias", "label", "canManageValues", "ngModel"], ["type", "text", "placeholder", "Value...", 1, "char-value-input", 3, "input", "value"], ["type", "button", 1, "char-remove-btn", 3, "click"]], template: function CharacteristicsEditorComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "label", 1);
      \u0275\u0275text(2);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "div", 2);
      \u0275\u0275repeaterCreate(4, CharacteristicsEditorComponent_For_5_Template, 5, 5, "div", 3, \u0275\u0275repeaterTrackByIndex);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "button", 4);
      \u0275\u0275listener("click", function CharacteristicsEditorComponent_Template_button_click_6_listener() {
        return ctx.addCharacteristic();
      });
      \u0275\u0275text(7, "+ Add Characteristic");
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.label);
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.characteristics());
    }
  }, dependencies: [CommonModule, FormsModule, NgControlStatus, NgModel, RfValueSelectComponent], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n  width: 100%;\n}\n.characteristics-editor[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 0.5rem;\n  margin-bottom: 1rem;\n}\n.editor-label[_ngcontent-%COMP%] {\n  font-weight: 600;\n  font-size: 0.875rem;\n  color: var(--primary-text);\n  margin-bottom: 0.25rem;\n}\n.char-list[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 0.5rem;\n}\n.char-row[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: flex-start;\n  gap: 0.5rem;\n}\n.char-row[_ngcontent-%COMP%]   app-rf-value-select[_ngcontent-%COMP%] {\n  flex: 0 0 40%;\n  min-width: 0;\n}\n.char-value-input[_ngcontent-%COMP%] {\n  flex: 1 1 50%;\n  padding: 0.5rem 0.75rem;\n  border: 1px solid var(--border-color);\n  border-radius: 4px;\n  background-color: var(--primary-background);\n  color: var(--primary-text);\n  font-size: 0.875rem;\n  box-sizing: border-box;\n  transition: border-color 0.2s ease, box-shadow 0.2s ease;\n}\n.char-value-input[_ngcontent-%COMP%]:focus {\n  outline: none;\n  border-color: var(--accent-color);\n  box-shadow: 0 0 0 2px var(--accent-color-shadow);\n}\n.char-value-input[_ngcontent-%COMP%]::placeholder {\n  color: var(--secondary-text);\n}\n.char-remove-btn[_ngcontent-%COMP%] {\n  flex: 0 0 auto;\n  padding: 0.4rem 0.6rem;\n  border: 1px solid var(--border-color);\n  border-radius: 4px;\n  background-color: transparent;\n  color: #e74c3c;\n  font-size: 0.875rem;\n  cursor: pointer;\n  transition: background-color 0.2s ease, color 0.2s ease;\n  line-height: 1;\n}\n.char-remove-btn[_ngcontent-%COMP%]:hover {\n  background-color: #e74c3c;\n  color: #fff;\n  border-color: #e74c3c;\n}\n.char-add-btn[_ngcontent-%COMP%] {\n  align-self: flex-start;\n  padding: 0.4rem 0.75rem;\n  border: 1px dashed var(--border-color);\n  border-radius: 4px;\n  background-color: transparent;\n  color: var(--primary-text);\n  font-size: 0.8rem;\n  cursor: pointer;\n  transition: background-color 0.2s ease, border-color 0.2s ease;\n}\n.char-add-btn[_ngcontent-%COMP%]:hover {\n  background-color: var(--secondary-background);\n  border-color: var(--accent-color);\n  color: var(--accent-color);\n}\n/*# sourceMappingURL=characteristics-editor.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CharacteristicsEditorComponent, { className: "CharacteristicsEditorComponent", filePath: "src/app/shared/reactive-form/refactored/input-fields/characteristics-editor/characteristics-editor.component.ts", lineNumber: 22 });
})();

// src/app/shared/reactive-form/refactored/input-fields/loto-standard-select/loto-standard-select.component.ts
var _forTrack010 = ($index, $item) => $item.value;
function LotoStandardSelectComponent_Conditional_8_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 8);
    \u0275\u0275listener("click", function LotoStandardSelectComponent_Conditional_8_For_2_Template_button_click_0_listener() {
      const option_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.removeOption(+option_r2.value));
    });
...
function LotoStandardSelectComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5);
    \u0275\u0275repeaterCreate(1, LotoStandardSelectComponent_Conditional_8_For_2_Template, 5, 1, "button", 7, _forTrack010);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.selectedOptions());
  }
}
function LotoStandardSelectComponent_Conditional_9_Conditional_5_For_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 18);
    \u0275\u0275listener("click", function LotoStandardSelectComponent_Conditional_9_Conditional_5_For_4_Template_button_click_0_listener() {
      const option_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.removeOption(+option_r6.value));
    });
    \u0275\u0275elementStart(1, "span");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function LotoStandardSelectComponent_Conditional_9_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13);
    \u0275\u0275text(1, "Selected");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div", 16);
    \u0275\u0275repeaterCreate(3, LotoStandardSelectComponent_Conditional_9_Conditional_5_For_4_Template, 5, 1, "button", 17, _forTrack010);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function LotoStandardSelectComponent_Conditional_9_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15);
    \u0275\u0275text(1, "No LOTO standards are available yet");
    \u0275\u0275elementEnd();
  }
}
function LotoStandardSelectComponent_Conditional_9_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15);
    \u0275\u0275text(1, "No matching standards");
    \u0275\u0275elementEnd();
  }
}
function LotoStandardSelectComponent_Conditional_9_Conditional_11_For_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 21);
    \u0275\u0275listener("click", function LotoStandardSelectComponent_Conditional_9_Conditional_11_For_1_Template_button_click_0_listener() {
      const option_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.toggleOption(option_r8));
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("option-item-selected", ctx_r2.isSelected(option_r8.value));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.isSelected(option_r8.value) ? "\u2713" : "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(option_r8.label);
  }
}
function LotoStandardSelectComponent_Conditional_9_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, LotoStandardSelectComponent_Conditional_9_Conditional_11_For_1_Template, 5, 4, "button", 20, _forTrack010);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function LotoStandardSelectComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 6)(1, "div", 10)(2, "input", 11);
    \u0275\u0275listener("input", function LotoStandardSelectComponent_Conditional_9_Template_input_input_2_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function LotoStandardSelectComponent_Conditional_9_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(4, "Done");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(5, LotoStandardSelectComponent_Conditional_9_Conditional_5_Template, 5, 0);
    \u0275\u0275elementStart(6, "div", 13);
    \u0275\u0275text(7, "Available Standards");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 14);
    \u0275\u0275template(9, LotoStandardSelectComponent_Conditional_9_Conditional_9_Template, 2, 0, "div", 15)(10, LotoStandardSelectComponent_Conditional_9_Conditional_10_Template, 2, 0, "div", 15)(11, LotoStandardSelectComponent_Conditional_9_Conditional_11_Template, 2, 0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r2.selectedOptions().length ? 5 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r2.options().length === 0 ? 9 : ctx_r2.filteredOptions().length === 0 ? 10 : 11);
  }
}
var LotoStandardSelectComponent = class _LotoStandardSelectComponent {
  label = input("LOTO Standards");
  options = input([]);
  elementRef = inject(ElementRef);
  selectedValues = signal([]);
  searchTerm = signal("");
  ...
  selectedOptions = computed(() => {
    const byId = new Map(this.options().map((option) => [Number(option.value), option]));
    return this.selectedValues().map((id) => byId.get(id)).filter((option) => !!option);
  });
  ...
  writeValue(value) {
    if (Array.isArray(value)) {
      this.selectedValues.set(value.map((item) => Number(typeof item === "object" && item !== null ? item.id : item)).filter((item) => !Number.isNaN(item)));
      return;
    }
    this.selectedValues.set([]);
  }
  ...
  addOption(option) {
    ...
    if (Number.isNaN(id) || this.selectedValues().includes(id))
      return;
  ...
  static \u0275fac = function LotoStandardSelectComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _LotoStandardSelectComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LotoStandardSelectComponent, selectors: [["app-loto-standard-select"]], hostBindings: function LotoStandardSelectComponent_HostBindings(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275listener("click", function LotoStandardSelectComponent_click_HostBindingHandler($event) {
        return ctx.onDocumentClick($event);
      }, false, \u0275\u0275resolveDocument);
    }
  }, inputs: { label: [1, "label"], options: [1, "options"] }, features: [\u0275\u0275ProvidersFeature([
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => _LotoStandardSelectComponent),
      multi: true
    }
  ])], decls: 10, vars: 6, consts: [[1, "loto-standard-select"], [1, "field-label"], ["type", "button", 1, "trigger", 3, "click", "disabled"], [1, "trigger-text"], [1, "trigger-caret"], [1, "selected-list"], [1, "panel"], ["type", "button", 1, "selected-chip"], ["type", "button", 1, "selected-chip", 3, "click"], [1, "chip-close"], [1, "panel-header"], ["type", "text", "placeholder", "Search standards...", 1, "search-input", 3, "input", "value"], ["type", "button", 1, "done-btn", 3, "click"], [1, "section-title"], [1, "options-list"], [1, "empty-state"], [1, "selected-panel-list"], ["type", "button", 1, "selected-row"], ["type", "button", 1, "selected-row", 3, "click"], [1, "selected-row-action"], ["type", "button", 1, "option-item", 3, "option-item-selected"], ["type", "button", 1, "option-item", 3, "click"], [1, "option-check"], [1, "option-label"]], template: function LotoStandardSelectComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "label", 1);
      \u0275\u0275text(2);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "button", 2);
      \u0275\u0275listener("click", function LotoStandardSelectComponent_Template_button_click_3_listener() {
      ...
      \u0275\u0275text(7);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(8, LotoStandardSelectComponent_Conditional_8_Template, 3, 0, "div", 5)(9, LotoStandardSelectComponent_Conditional_9_Template, 12, 3, "div", 6);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.triggerText());
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.isOpen() ? "\u25B2" : "\u25BC");
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.selectedOptions().length ? 8 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.isOpen() ? 9 : -1);
    }
  }, dependencies: [CommonModule], styles: ["\n\n.loto-standard-select[_ngcontent-%COMP%] {\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n}\n.field-label[_ngcontent-%COMP%] {\n  font-size: 13px;\n  font-weight: 600;\n  color: #334155;\n}\n.trigger[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  width: 100%;\n  min-height: 42px;\n  padding: 10px 12px;\n  border: 1px solid #cbd5e1;\n  border-radius: 10px;\n  background: #fff;\n  color: #0f172a;\n  cursor: pointer;\n  text-align: left;\n}\n.trigger[_ngcontent-%COMP%]:disabled {\n  opacity: 0.6;\n  cursor: not-allowed;\n}\n.trigger-text[_ngcontent-%COMP%] {\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  padding-right: 12px;\n}\n.trigger-caret[_ngcontent-%COMP%] {\n  color: #64748b;\n  font-size: 11px;\n  flex-shrink: 0;\n}\n.selected-list[_ngcontent-%COMP%] {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 8px;\n}\n.selected-chip[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  gap: 8px;\n  padding: 6px 10px;\n  border: 1px solid #bfdbfe;\n  border-radius: 999px;\n  background: #eff6ff;\n  color: #1d4ed8;\n  cursor: pointer;\n}\n.chip-close[_ngcontent-%COMP%] {\n  font-size: 11px;\n  color: #475569;\n}\n.panel[_ngcontent-%COMP%] {\n  position: absolute;\n  top: calc(100% + 4px);\n  left: 0;\n  right: 0;\n  z-index: 20;\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  padding: 12px;\n  border: 1px solid #cbd5e1;\n  border-radius: 12px;\n  background: #fff;\n  box-shadow: 0 16px 36px rgba(15, 23, 42, 0.15);\n}\n.panel-header[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 8px;\n  align-items: center;\n}\n.search-input[_ngcontent-%COMP%] {\n  flex: 1;\n  width: 100%;\n  padding: 9px 10px;\n  border: 1px solid #cbd5e1;\n  border-radius: 8px;\n}\n.done-btn[_ngcontent-%COMP%] {\n  border: 1px solid #cbd5e1;\n  border-radius: 8px;\n  background: #f8fafc;\n  color: #0f172a;\n  padding: 9px 12px;\n  cursor: pointer;\n}\n.section-title[_ngcontent-%COMP%] {\n  font-size: 12px;\n  font-weight: 700;\n  letter-spacing: 0.04em;\n  text-transform: uppercase;\n  color: #64748b;\n}\n.selected-panel-list[_ngcontent-%COMP%], \n.options-list[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 6px;\n  max-height: 220px;\n  overflow-y: auto;\n}\n.selected-row[_ngcontent-%COMP%], \n.option-item[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  width: 100%;\n  padding: 10px 12px;\n  border: 1px solid #e2e8f0;\n  border-radius: 10px;\n  background: #fff;\n  color: #0f172a;\n  text-align: left;\n  cursor: pointer;\n}\n.selected-row[_ngcontent-%COMP%] {\n  justify-content: space-between;\n  background: #f8fafc;\n}\n.selected-row-action[_ngcontent-%COMP%] {\n  font-size: 12px;\n  color: #475569;\n}\n.option-item-selected[_ngcontent-%COMP%] {\n  border-color: #93c5fd;\n  background: #eff6ff;\n}\n.option-check[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  width: 18px;\n  height: 18px;\n  border: 1px solid #cbd5e1;\n  border-radius: 4px;\n  color: #2563eb;\n  font-size: 12px;\n  flex-shrink: 0;\n}\n.option-item-selected[_ngcontent-%COMP%]   .option-check[_ngcontent-%COMP%] {\n  border-color: #60a5fa;\n  background: #dbeafe;\n}\n.option-label[_ngcontent-%COMP%] {\n  flex: 1;\n}\n.empty-state[_ngcontent-%COMP%] {\n  padding: 12px 10px;\n  color: #64748b;\n  text-align: center;\n  border: 1px dashed #cbd5e1;\n  border-radius: 10px;\n  background: #f8fafc;\n}\n/*# sourceMappingURL=loto-standard-select.component.css.map */"], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LotoStandardSelectComponent, { className: "LotoStandardSelectComponent", filePath: "src/app/shared/reactive-form/refactored/input-fields/loto-standard-select/loto-standard-select.component.ts", lineNumber: 31 });
})();
...
var UserService = class _UserService {
  ...
  changePassword(id, oldPassword, newPassword) {
    ...
    return this.http.post(`${this.apiUrl}/${id}/change-password`, payload);
  }
  getRoles() {
    return this.http.get(`${this.apiUrl}/roles`);
  }
  seedPlantUsers() {
    return this.http.post(`${this.apiUrl}/seed-plant-users`, {});
  }
...
// src/app/features/users/services/rf-user-option.service.ts
var RfUserOptionService = class _RfUserOptionService {
  userService = inject(UserService);
  destroyRef = inject(DestroyRef);
  allUsers = signal([]);
  loaded = false;
  /** All active users as Option[] for dropdowns */
  userOptions = computed(() => this.allUsers().map((u) => u.toOption()));
  constructor() {
    this.userService.userUpdated$.pipe(takeUntilDestroyed(this.destroyRef)).subscribe(() => this.refreshUsers());
    this.userService.userDeleted$.pipe(takeUntilDestroyed(this.destroyRef)).subscribe(() => this.refreshUsers());
  }
  ...
  getFilteredOptions(roleFilter) {
    if (!this.loaded) {
      this.loadUsers();
    }
    return this.allUsers().filter((u) => u.roles?.includes(roleFilter)).map((u) => u.toOption());
  }
  loadUsers() {
    if (this.loaded)
      return;
    this.loaded = true;
    this.userService.getAllOptions().pipe(takeUntilDestroyed(this.destroyRef)).subscribe({
      next: (response) => {
  ...
  static \u0275fac = function RfUserOptionService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _RfUserOptionService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _RfUserOptionService, factory: _RfUserOptionService.\u0275fac, providedIn: "root" });
};

// src/app/features/users/components/rf-user-select/rf-user-select.component.ts
var _c07 = ["selectInput"];
var _c12 = ["suggestDropdown"];
var _c22 = ["textInput"];
var _forTrack011 = ($index, $item) => $item.value;
function RfUserSelectComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 3);
    \u0275\u0275element(1, "app-searchable-select-input", 4, 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function RfUserSelectComponent_Conditional_1_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 10);
    \u0275\u0275listener("click", function RfUserSelectComponent_Conditional_1_Conditional_8_Template_span_click_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.clearSuggest($event));
    });
    \u0275\u0275text(1, "\xD7");
    \u0275\u0275elementEnd();
  }
}
function RfUserSelectComponent_Conditional_1_ng_template_9_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 14);
    \u0275\u0275listener("click", function RfUserSelectComponent_Conditional_1_ng_template_9_For_2_Template_div_click_0_listener($event) {
      const option_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.selectSuggestion(option_r5, $event));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
...
function RfUserSelectComponent_Conditional_1_ng_template_9_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13);
    \u0275\u0275text(1, "No matching users");
    \u0275\u0275elementEnd();
  }
}
function RfUserSelectComponent_Conditional_1_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275repeaterCreate(1, RfUserSelectComponent_Conditional_1_ng_template_9_For_2_Template, 2, 1, "div", 12, _forTrack011);
    \u0275\u0275template(3, RfUserSelectComponent_Conditional_1_ng_template_9_Conditional_3_Template, 2, 0, "div", 13);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.filteredSuggestions().length === 0 ? 3 : -1);
  }
}
function RfUserSelectComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 3)(1, "div", 5)(2, "div", 6)(3, "label");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 7)(6, "input", 8, 1);
    \u0275\u0275listener("input", function RfUserSelectComponent_Conditional_1_Template_input_input_6_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onSuggestInput($event));
    })("focus", function RfUserSelectComponent_Conditional_1_Template_input_focus_6_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onSuggestFocus());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, RfUserSelectComponent_Conditional_1_Conditional_8_Template, 2, 0, "span", 9);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(9, RfUserSelectComponent_Conditional_1_ng_template_9_Template, 4, 1, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r0.label());
    \u0275\u0275advance(2);
    \u0275\u0275property("value", ctx_r0.suggestText())("disabled", ctx_r0.disabled());
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.suggestText() ? 8 : -1);
  }
}
var RfUserSelectComponent = class _RfUserSelectComponent {
  userOptionService = inject(RfUserOptionService);
  injector = inject(Injector);
  ...
  // Computed options
  options = computed(() => {
    const filter2 = this.roleFilter();
    if (filter2) {
      return this.userOptionService.getFilteredOptions(filter2);
    }
  ...
  filterSuggestions(text) {
    ...
    this.filteredSuggestions.set(this.options().filter((opt) => {
      const label = (opt.label || "").toLowerCase();
      return words.every((word) => label.includes(word));
    }));
  }
  emitMatchedUser(text) {
    if (!text.trim()) {
      this.userSelected.emit(null);
      return;
    }
    const match = this.options().find((opt) => (opt.label || "").toLowerCase() === text.toLowerCase().trim());
    if (match) {
  ...
  openSuggestDropdown() {
    if (this.suggestOpen() || !this.textInputRef)
      return;
  ...
  static \u0275fac = function RfUserSelectComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _RfUserSelectComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RfUserSelectComponent, selectors: [["app-rf-user-select"]], viewQuery: function RfUserSelectComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuery(_c07, 5);
      \u0275\u0275viewQuery(_c12, 5);
      \u0275\u0275viewQuery(_c22, 5);
    ...
    if (rf & 2) {
      let _t;
      \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.selectInput = _t.first);
      \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.suggestDropdown = _t.first);
      \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.textInputRef = _t.first);
    }
  }, hostBindings: function RfUserSelectComponent_HostBindings(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275listener("click", function RfUserSelectComponent_click_HostBindingHandler($event) {
        return ctx.onDocumentClick($event);
      }, false, \u0275\u0275resolveDocument);
    }
  }, inputs: { label: [1, "label"], roleFilter: [1, "roleFilter"], mode: [1, "mode"] }, outputs: { userSelected: "userSelected" }, features: [\u0275\u0275ProvidersFeature([{
    provide: NG_VALUE_ACCESSOR,
    useExisting: _RfUserSelectComponent,
    multi: true
  }])], decls: 2, vars: 1, consts: [["selectInput", ""], ["textInput", ""], ["suggestDropdown", ""], [1, "rf-user-select"], [3, "label", "options", "categoryName"], [1, "suggest-container"], [1, "label-container"], [1, "suggest-input-wrapper"], ["type", "text", "placeholder", "Type to search users...", "autocomplete", "off", 1, "suggest-input", 3, "input", "focus", "value", "disabled"], ["title", "Clear", 1, "clear-btn"], ["title", "Clear", 1, "clear-btn", 3, "click"], [1, "suggest-dropdown"], [1, "suggest-option"], [1, "suggest-no-match"], [1, "suggest-option", 3, "click"]], template: function RfUserSelectComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275template(0, RfUserSelectComponent_Conditional_0_Template, 3, 3, "div", 3)(1, RfUserSelectComponent_Conditional_1_Template, 11, 4);
    }
    if (rf & 2) {
      \u0275\u0275conditional(ctx.mode() === "strict" ? 0 : 1);
    }
  }, dependencies: [CommonModule, FormsModule, SearchableSelectInputComponent], styles: ["\n\n.rf-user-select[_ngcontent-%COMP%] {\n  position: relative;\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n}\n.suggest-container[_ngcontent-%COMP%] {\n  width: 100%;\n  margin-bottom: 1rem;\n}\n.label-container[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n}\n.label-container[_ngcontent-%COMP%]   label[_ngcontent-%COMP%] {\n  display: block;\n  margin-bottom: 0.5rem;\n  font-weight: 600;\n  font-size: 0.875rem;\n  color: var(--primary-text);\n}\n.suggest-input-wrapper[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  position: relative;\n}\n.suggest-input[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 0.5rem 0.75rem;\n  padding-right: 28px;\n  border: 1px solid var(--border-color);\n  border-radius: 4px;\n  background-color: var(--primary-background);\n  color: var(--primary-text);\n  font-size: inherit;\n  box-sizing: border-box;\n  min-height: 38px;\n  transition: border-color 0.2s ease-in-out, box-shadow 0.2s ease-in-out;\n}\n.suggest-input[_ngcontent-%COMP%]:hover {\n  border-color: var(--accent-color);\n}\n.suggest-input[_ngcontent-%COMP%]:focus {\n  outline: none;\n  border-color: var(--accent-color);\n  box-shadow: 0 0 0 0.2rem var(--accent-color-shadow);\n}\n.suggest-input[_ngcontent-%COMP%]:disabled {\n  opacity: 0.6;\n  cursor: not-allowed;\n  background-color: var(--secondary-background);\n}\n.clear-btn[_ngcontent-%COMP%] {\n  position: absolute;\n  right: 8px;\n  padding: 0 4px;\n  font-size: 14px;\n  line-height: 1;\n  color: var(--secondary-text, #999);\n  cursor: pointer;\n  opacity: 0.6;\n}\n.clear-btn[_ngcontent-%COMP%]:hover {\n  opacity: 1;\n  color: var(--error-color, #ef5350);\n}\n.suggest-dropdown[_ngcontent-%COMP%] {\n  background-color: var(--card-background);\n  border: 1px solid var(--border-color);\n  border-radius: 4px;\n  max-height: 200px;\n  overflow-y: auto;\n  box-shadow: var(--card-shadow);\n}\n.suggest-option[_ngcontent-%COMP%] {\n  padding: 0.5rem 0.75rem;\n  cursor: pointer;\n  transition: background-color 0.2s ease;\n  color: var(--primary-text);\n  line-height: 1.4;\n}\n.suggest-option[_ngcontent-%COMP%]:hover {\n  background-color: var(--menu-item-hover-bg-color);\n}\n.suggest-no-match[_ngcontent-%COMP%] {\n  padding: 0.5rem 0.75rem;\n  color: var(--secondary-text);\n  text-align: center;\n  font-size: 0.875rem;\n}\n.suggest-dropdown[_ngcontent-%COMP%]::-webkit-scrollbar {\n  width: 8px;\n}\n.suggest-dropdown[_ngcontent-%COMP%]::-webkit-scrollbar-track {\n  background: var(--secondary-background);\n}\n.suggest-dropdown[_ngcontent-%COMP%]::-webkit-scrollbar-thumb {\n  background: var(--secondary-text);\n  border-radius: 4px;\n}\n.suggest-dropdown[_ngcontent-%COMP%]::-webkit-scrollbar-thumb:hover {\n  background: var(--primary-text);\n}\n  .transparent-backdrop {\n  background-color: transparent !important;\n}\n/*# sourceMappingURL=rf-user-select.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RfUserSelectComponent, { className: "RfUserSelectComponent", filePath: "src/app/features/users/components/rf-user-select/rf-user-select.component.ts", lineNumber: 26 });
})();
...
var FormDataService = class _FormDataService {
   ...
   */
  isSignal(item) {
    return item && typeof item === "function" && typeof item.asReadonly === "function";
  }
  /**
...
var _c08 = [[["", "extra-buttons", ""]]];
var _c13 = ["[extra-buttons]"];
var _forTrack012 = ($index, $item) => $item.name;
...
function RfReactiveFormComponent_For_4_For_3_Conditional_0_Case_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const field_r3 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("options", ctx_r0.getFieldOptions(field_r3.options))("label", field_r3.label)("formControl", ctx_r0.getFormControl(field_r3.name))("categoryName", (tmp_25_0 = field_r3.categoryAlias) !== null && tmp_25_0 !== void 0 ? tmp_25_0 : "");
  }
}
function RfReactiveFormComponent_For_4_For_3_Conditional_0_Case_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-file-input", 27);
...
function RfReactiveFormComponent_For_4_For_3_Conditional_0_Case_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-form-array-input", 28);
...
function RfReactiveFormComponent_For_4_For_3_Conditional_0_Case_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-rf-user-select", 21);
  }
  if (rf & 2) {
    let tmp_23_0;
    const field_r3 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("label", field_r3.label)("mode", (tmp_23_0 = field_r3.userSelectMode) !== null && tmp_23_0 !== void 0 ? tmp_23_0 : "suggest")("formControl", ctx_r0.getFormControl(field_r3.name));
  }
}
...
function RfReactiveFormComponent_For_4_For_3_Conditional_0_Case_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-loto-standard-select", 11);
  }
  if (rf & 2) {
    const field_r3 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function RfReactiveFormComponent_For_4_For_3_Conditional_0_Case_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-work-area-select", 29);
    \u0275\u0275listener("workAreaSelected", function RfReactiveFormComponent_For_4_For_3_Conditional_0_Case_18_Template_app_work_area_select_workAreaSelected_0_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r0.onWorkAreaSelected($event));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const field_r3 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("label", field_r3.label)("viewMode", (tmp_23_0 = field_r3.context == null ? null : field_r3.context.viewMode) !== null && tmp_23_0 !== void 0 ? tmp_23_0 : "dropdown")("formControl", ctx_r0.getFormControl(field_r3.name));
  }
}
function RfReactiveFormComponent_For_4_For_3_Conditional_0_Case_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-characteristics-editor", 23);
  }
  if (rf & 2) {
    const field_r3 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("formControl", ctx_r0.getFormControl(field_r3.name))("label", field_r3.label)("categoryAlias", field_r3.categoryAlias);
  }
}
function RfReactiveFormComponent_For_4_For_3_Conditional_0_Case_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-comment-input", 24);
  }
  if (rf & 2) {
    let tmp_23_0;
    let tmp_24_0;
...
function RfReactiveFormComponent_For_4_For_3_Conditional_0_Case_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-rf-form-input", 25);
  }
  if (rf & 2) {
    let tmp_24_0;
    const field_r3 = \u0275\u0275nextContext(2).$implicit;
...
function RfReactiveFormComponent_For_4_For_3_Conditional_0_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
...
function RfReactiveFormComponent_For_4_For_3_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_26_0 = field_r3.type) === "select" ? 2 : tmp_26_0 === "checkbox-group" ? 3 : tmp_26_0 === "checkbox" ? 4 : tmp_26_0 === "radio-group" ? 5 : tmp_26_0 === "multi-select" ? 6 : tmp_26_0 === "file" ? 7 : tmp_26_0 === "multi-input" ? 8 : tmp_26_0 === "form-array" ? 9 : tmp_26_0 === "group" ? 10 : tmp_26_0 === "equipment-browser" ? 11 : tmp_26_0 === "equipment-shape-drawer" ? 12 : tmp_26_0 === "equipment-list-manager" ? 13 : tmp_26_0 === "value-select" ? 14 : tmp_26_0 === "user-select" ? 15 : tmp_26_0 === "multi-value-select" ? 16 : tmp_26_0 === "loto-standard-select" ? 17 : tmp_26_0 === "work-area-select" ? 18 : tmp_26_0 === "characteristics-editor" ? 19 : tmp_26_0 === "comment" ? 20 : 21);
    \u0275\u0275advance(20);
    \u0275\u0275conditional(ctx_r0.formErrors()[field_r3.name] ? 22 : -1);
  }
}
function RfReactiveFormComponent_For_4_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, RfReactiveFormComponent_For_4_For_3_Conditional_0_Template, 23, 8, "div", 7);
  }
  if (rf & 2) {
    const field_r3 = ctx.$implicit;
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function RfReactiveFormComponent_For_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, RfReactiveFormComponent_For_4_For_3_Template, 1, 1, null, null, _forTrack012);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function RfReactiveFormComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4)(1, "button", 30);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, RfReactiveFormComponent_Conditional_5_Conditional_3_Template, 2, 1, "button", 31);
    \u0275\u0275projection(4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var RfReactiveFormComponent = class _RfReactiveFormComponent {
  ...
  applyConstantValues(source, formGroupName) {
    const patch = {};
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RfReactiveFormComponent, { className: "RfReactiveFormComponent", filePath: "src/app/shared/reactive-form/refactored/reactive-form/rf-reactive-form.component.ts", lineNumber: 62 });
})();
...
//# sourceMappingURL=chunk-3RTK7GTF.js.map
