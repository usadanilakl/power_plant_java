...
function SearchableSelectInputComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 6);
    \u0275\u0275listener("click", function SearchableSelectInputComponent_Conditional_7_Template_span_click_0_listener($event) {
      \u0275\u0275restoreView(_r2);
...
function SearchableSelectInputComponent_ng_template_8_For_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 13);
    \u0275\u0275listener("click", function SearchableSelectInputComponent_ng_template_8_For_7_Template_div_click_0_listener($event) {
      const option_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.selectOption(option_r6, $event));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", option_r6.label || option_r6.name, " ");
  }
}
function SearchableSelectInputComponent_ng_template_8_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function SearchableSelectInputComponent_ng_template_8_Conditional_9_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 18);
    \u0275\u0275listener("click", function SearchableSelectInputComponent_ng_template_8_Conditional_9_Conditional_10_Template_div_click_0_listener($event) {
      \u0275\u0275restoreView(_r8);
...
function SearchableSelectInputComponent_ng_template_8_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function SearchableSelectInputComponent_ng_template_8_Conditional_9_Template_div_click_2_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function SearchableSelectInputComponent_ng_template_8_Conditional_9_Template_div_click_6_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275template(10, SearchableSelectInputComponent_ng_template_8_Conditional_9_Conditional_10_Template, 4, 1, "div", 17);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
...
function SearchableSelectInputComponent_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 7)(1, "div", 8)(2, "input", 9);
    \u0275\u0275listener("input", function SearchableSelectInputComponent_ng_template_8_Template_input_input_2_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.filterOptions($event));
    })("click", function SearchableSelectInputComponent_ng_template_8_Template_input_click_2_listener($event) {
      \u0275\u0275restoreView(_r4);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 10);
    \u0275\u0275listener("click", function SearchableSelectInputComponent_ng_template_8_Template_button_click_3_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275pipe(5, "uppercase");
    \u0275\u0275elementEnd()();
    \u0275\u0275repeaterCreate(6, SearchableSelectInputComponent_ng_template_8_For_7_Template, 2, 1, "div", 11, _forTrack0);
    \u0275\u0275template(8, SearchableSelectInputComponent_ng_template_8_Conditional_8_Template, 2, 0, "div", 12)(9, SearchableSelectInputComponent_ng_template_8_Conditional_9_Template, 11, 3);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var SearchableSelectInputComponent = class _SearchableSelectInputComponent {
  ...
  ])], decls: 10, vars: 5, consts: [["dropdownTemplate", ""], [1, "dropdown-container"], [1, "label-container"], [1, "dropdown-input", 3, "click"], [1, "selected-text"], ["title", "Clear selection", 1, "clear-btn"], ["title", "Clear selection", 1, "clear-btn", 3, "click"], [1, "dropdown-options"], [1, "search-container"], ["type", "text", "placeholder", "Search...", 3, "input", "click", "value"], ["type", "button", "title", "Toggle AND/OR search mode", 1, "search-mode-toggle", 3, "click"], [1, "dropdown-option"], [1, "no-options"], [1, "dropdown-option", 3, "click"], [1, "option-divider"], [1, "add-new-option", 3, "click"], [1, "plus-icon"], [1, "add-new-option", "delete-option"], [1, "add-new-option", "delete-option", 3, "click"]], template: function SearchableSelectInputComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(6);
      \u0275\u0275elementEnd();
      \u0275\u0275template(7, SearchableSelectInputComponent_Conditional_7_Template, 2, 0, "span", 5);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(8, SearchableSelectInputComponent_ng_template_8_Template, 10, 8, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.selectedDisplay());
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.internalValue() !== null && ctx.internalValue() !== void 0 && !ctx.isDisabled() ? 7 : -1);
    }
...
function WorkAreaMapPickerComponent_Conditional_3_For_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngStyle", ctx_r0.isSelected(shape_r6) ? ctx_r0.mergeStyles(ctx_r0.getShapeStyle(shape_r6), ctx_r0.getSelectedShapeCounterStyle()) : ctx_r0.mergeStyles(ctx_r0.getShapeStyle(shape_r6), ctx_r0.getShapeCounterStyle()));
    \u0275\u0275advance();
    \u0275\u0275property("ngStyle", ctx_r0.getLabelStyle(shape_r6));
    \u0275\u0275advance();
    \u0275\u0275classProp("selected", ctx_r0.isSelected(shape_r6));
    \u0275\u0275property("ngStyle", ctx_r0.isSelected(shape_r6) ? ctx_r0.getSelectedLabelCounterStyle() : ctx_r0.getLabelCounterStyle());
    \u0275\u0275advance();
...
function WorkAreaMapPickerComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("wheel", function WorkAreaMapPickerComponent_Conditional_3_Template_div_wheel_1_listener($event) {
      ...
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onMouseUp());
    })("touchstart", function WorkAreaMapPickerComponent_Conditional_3_Template_div_touchstart_1_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onTouchStart($event));
    })("touchmove", function WorkAreaMapPickerComponent_Conditional_3_Template_div_touchmove_1_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onTouchMove($event));
    })("touchend", function WorkAreaMapPickerComponent_Conditional_3_Template_div_touchend_1_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onTouchEnd());
    });
    \u0275\u0275elementStart(3, "div", 7, 1);
    \u0275\u0275element(5, "img", 8);
    \u0275\u0275repeaterCreate(6, WorkAreaMapPickerComponent_Conditional_3_For_7_Template, 4, 8, null, null, _forTrack02);
    \u0275\u0275elementEnd()();
...
function WorkAreaSelectComponent_Case_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("label", ctx_r0.label())("options", ctx_r0.options())("categoryName", "");
    \u0275\u0275advance(5);
    \u0275\u0275property("isOpen", ctx_r0.isMapOpen())("fullHeight", true)("zIndex", 99999);
  }
}
...
var WorkAreaSelectComponent = class _WorkAreaSelectComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WorkAreaSelectComponent, selectors: [["app-work-area-select"]], viewQuery: function WorkAreaSelectComponent_Query(rf, ctx) {
    ...
    multi: true
  }])], decls: 5, vars: 2, consts: [["selectInput", ""], ["mapPicker", ""], ["popupMapPicker", ""], [1, "work-area-select"], [3, "label", "options", "categoryName"], [1, "both-wrapper"], [1, "fallback-location"], [1, "map-label"], [3, "workAreaSelected"], [1, "dropdown-with-map-btn"], ["type", "button", "title", "Open map", 1, "map-btn", 3, "click"], ["viewBox", "0 0 24 24", "width", "20", "height", "20", "fill", "currentColor"], ["d", "M20.5 3l-.16.03L15 5.1 9 3 3.36 4.9c-.21.07-.36.25-.36.48V20.5c0 .28.22.5.5.5l.16-.03L9 18.9l6 2.1 5.64-1.9c.21-.07.36-.25.36-.48V3.5c0-.28-.22-.5-.5-.5zM15 19l-6-2.11V5l6 2.11V19z"], ["title", "Select Work Area", "size", "xlarge", 3, "close", "isOpen", "fullHeight", "zIndex"], [2, "--map-height", "80vh", 3, "workAreaSelected"]], template: function WorkAreaSelectComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 3);
      \u0275\u0275template(1, WorkAreaSelectComponent_Case_1_Template, 2, 3, "app-searchable-select-input", 4)(2, WorkAreaSelectComponent_Case_2_Template, 4, 1)(3, WorkAreaSelectComponent_Case_3_Template, 10, 6, "div", 5)(4, WorkAreaSelectComponent_Conditional_4_Template, 2, 1, "div", 6);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      let tmp_0_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WorkAreaSelectComponent, { className: "WorkAreaSelectComponent", filePath: "src/app/features/permit-builder/work-area/components/work-area-select/work-area-select.component.ts", lineNumber: 120 });
})();
...
//# sourceMappingURL=chunk-R4XEPM3C.js.map
