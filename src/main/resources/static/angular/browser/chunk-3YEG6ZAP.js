...
var SafeWorkDto = class _SafeWorkDto extends BaseDto {
  ...
  static generatePermitFromRequest(request, workArea) {
    ...
    if (workArea?.constantHazards) {
      dto.hazards = new SwHazards(__spreadValues(__spreadValues({}, dto.hazards), workArea.constantHazards));
    }
    return dto;
  }
...
var HotWorkDto = class _HotWorkDto extends BaseDto {
  ...
  static generatePermitFromRequest(request, workArea) {
    ...
    if (workArea?.constantHotWorkMeasures) {
      dto.measures = new HotWorkMeasures(__spreadValues(__spreadValues({}, dto.measures), workArea.constantHotWorkMeasures));
    }
    return dto;
  }
  static formatLabel(key) {
...
var ConfinedSpaceDto = class _ConfinedSpaceDto extends BaseDto {
  ...
  static generatePermitFromRequest(request, workArea) {
    ...
    if (workArea?.constantConfinedSpaceHazards) {
      dto.hazards = new ConfinedSpaceHazards(__spreadValues(__spreadValues({}, dto.hazards), workArea.constantConfinedSpaceHazards));
    }
    return dto;
  }
  static formatLabel(key) {
...
var WorkAreaDto = class _WorkAreaDto extends BaseDto {
  ...
  static toFormFields(entity, lotoStandardOptions = []) {
    return [
      {
        name: "name",
        label: "Area Name",
...
//# sourceMappingURL=chunk-3YEG6ZAP.js.map
