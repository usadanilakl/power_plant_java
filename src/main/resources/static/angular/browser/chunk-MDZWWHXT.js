...
var EntityLoaderService = class _EntityLoaderService {
  ...
  loadEntityFields(formType) {
    ...
    switch (formType) {
      ...
      case "JobStep":
        return entity.getFormFields();
      case "EnergizedWorkPermit":
        return EnergizedWorkPermitDto.toFormFields(entity);
      case "ExcavationPermit":
        return ExcavationPermitDto.toFormFields(entity);
      case "VentingPermit":
        return VentingPermitDto.toFormFields(entity);
      default:
        return [];
    }
  }
  ...
  getSampleData(formType) {
    switch (formType) {
      ...
      case "EnergizedWorkPermit":
        return this.getEnergizedWorkSample();
      case "ExcavationPermit":
        return this.getExcavationSample();
      case "VentingPermit":
        return this.getVentingSample();
      case "WorkRequest":
...
//# sourceMappingURL=chunk-MDZWWHXT.js.map
