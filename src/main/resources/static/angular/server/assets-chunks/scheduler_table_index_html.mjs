...
.header-menus[_ngcontent-ng-c2343959896] {
  display: flex;
  flex-direction: column;
  width: 100%;
  padding: 10px;
...
.menu-container[_ngcontent-ng-c2343959896] {
  width: 100%;
  padding: 10px 15px;
  margin-bottom: 10px;
  border-radius: 8px;
...
.menu-container[_ngcontent-ng-c2343959896]:first-child {
  background-color: rgba(2, 43, 97, 0.644);
  -webkit-backdrop-filter: blur(10px);
  backdrop-filter: blur(10px);
}
.menu-container[_ngcontent-ng-c2343959896]:first-child     app-router-menu {
  --router-menu-text-color: white;
  --router-menu-text-hover-color: rgb(163, 201, 237);
}
.menu-container[_ngcontent-ng-c2343959896]:last-child {
  background-color: rgba(2, 43, 97, 0.644);
  -webkit-backdrop-filter: blur(10px);
  backdrop-filter: blur(10px);
}
.menu-container[_ngcontent-ng-c2343959896]:last-child     app-router-menu {
  --router-menu-text-color: white;
  --router-menu-text-hover-color: rgb(163, 201, 237);
}
.menu-container[_ngcontent-ng-c2343959896]:hover {
  transform: translateY(-2px);
  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.15);
}
.menu-container[_ngcontent-ng-c2343959896]     a {
  color: white;
...
.menu-container[_ngcontent-ng-c2343959896]     a:hover {
...
}--></button></app-theme-toggle></div></header><div _ngcontent-ng-c3342727180="" class="content-wrapper"><!--container--><div _ngcontent-ng-c3342727180="" class="main-and-footer"><main _ngcontent-ng-c3342727180="" class="main-content"><router-outlet _ngcontent-ng-c2343959896=""></router-outlet><app-file-table _nghost-ng-c27128149="" ngh="12"><app-shared-table _ngcontent-ng-c27128149="" _nghost-ng-c2108134260="" ng-reflect-columns="[object Object],[object Object" ng-reflect-items="[object Object]" ng-reflect-click-callback="(item, event) =&gt; {
    if (eve" ng-reflect-delete-item="function () { [native code] }" ngh="10"><div _ngcontent-ng-c2108134260="" class="table-wrapper"><div _ngcontent-ng-c2108134260="" class="table-controls"><div _ngcontent-ng-c2108134260="" class="default-controls"><div _ngcontent-ng-c2108134260="" class="button-row"><button _ngcontent-ng-c2108134260="" jsaction="click:;">Delete Selected</button><button _ngcontent-ng-c27128149="" table-controls="" jsaction="click:;">Add New File</button></div><div _ngcontent-ng-c2108134260="" class="search-row"><input _ngcontent-ng-c2108134260="" appcopypaste="" type="text" placeholder="Global Search..." class="search-input ng-untouched ng-pristine ng-valid" ng-reflect-model="" value="" jsaction="input:;blur:;compositionstart:;compositionend:;click:;"></div></div></div><cdk-virtual-scroll-viewport _ngcontent-ng-c2108134260="" itemsize="50" class="cdk-virtual-scroll-viewport table-container cdk-virtual-scrollable cdk-virtual-scroll-orientation-vertical" ng-reflect-item-size="50" ngh="0"><div class="cdk-virtual-scroll-content-wrapper"><table _ngcontent-ng-c2108134260=""><thead _ngcontent-ng-c2108134260=""><tr _ngcontent-ng-c2108134260=""><th _ngcontent-ng-c2108134260="" jsaction="click:;"> Verified <div _ngcontent-ng-c2108134260="" class="resizer"></div></th><th _ngcontent-ng-c2108134260="" jsaction="click:;"> File Name <div _ngcontent-ng-c2108134260="" class="resizer"></div></th><th _ngcontent-ng-c2108134260="" jsaction="click:;"> Vendor <div _ngcontent-ng-c2108134260="" class="resizer"></div></th><th _ngcontent-ng-c2108134260="" jsaction="click:;"> File Type <div _ngcontent-ng-c2108134260="" class="resizer"></div></th><th _ngcontent-ng-c2108134260="" jsaction="click:;"> File Number <div _ngcontent-ng-c2108134260="" class="resizer"></div></th><th _ngcontent-ng-c2108134260="" jsaction="click:;"> Systems <div _ngcontent-ng-c2108134260="" class="resizer"></div></th><!--container--></tr><tr _ngcontent-ng-c2108134260=""><th _ngcontent-ng-c2108134260=""><input _ngcontent-ng-c2108134260="" appcopypaste="" type="text" class="filter-input ng-untouched ng-pristine ng-valid" placeholder="Filter Verified" value="" jsaction="input:;blur:;compositionstart:;compositionend:;click:;"></th><th _ngcontent-ng-c2108134260=""><input _ngcontent-ng-c2108134260="" appcopypaste="" type="text" class="filter-input ng-untouched ng-pristine ng-valid" placeholder="Filter File Name" value="" jsaction="input:;blur:;compositionstart:;compositionend:;click:;"></th><th _ngcontent-ng-c2108134260=""><input _ngcontent-ng-c2108134260="" appcopypaste="" type="text" class="filter-input ng-untouched ng-pristine ng-valid" placeholder="Filter Vendor" value="" jsaction="input:;blur:;compositionstart:;compositionend:;click:;"></th><th _ngcontent-ng-c2108134260=""><input _ngcontent-ng-c2108134260="" appcopypaste="" type="text" class="filter-input ng-untouched ng-pristine ng-valid" placeholder="Filter File Type" value="" jsaction="input:;blur:;compositionstart:;compositionend:;click:;"></th><th _ngcontent-ng-c2108134260=""><input _ngcontent-ng-c2108134260="" appcopypaste="" type="text" class="filter-input ng-untouched ng-pristine ng-valid" placeholder="Filter File Number" value="" jsaction="input:;blur:;compositionstart:;compositionend:;click:;"></th><th _ngcontent-ng-c2108134260=""><input _ngcontent-ng-c2108134260="" appcopypaste="" type="text" class="filter-input ng-untouched ng-pristine ng-valid" placeholder="Filter Systems" value="" jsaction="input:;blur:;compositionstart:;compositionend:;click:;"></th><!--container--></tr></thead><tbody _ngcontent-ng-c2108134260=""><!--bindings={
  "ng-reflect-cdk-virtual-for-of": "[object Object]"
}--></tbody></table></div><div class="cdk-virtual-scroll-spacer"></div></cdk-virtual-scroll-viewport></div></app-shared-table><app-popup-projection _ngcontent-ng-c27128149="" _nghost-ng-c4000021521="" ng-reflect-is-open="false" ng-reflect-title="File Details" ng-reflect-size="large" ngh="11"><!--container--></app-popup-projection><app-popup-projection _ngcontent-ng-c27128149="" _nghost-ng-c4000021521="" ng-reflect-is-open="false" ng-reflect-title="Image View" ngh="11"><!--container--></app-popup-projection></app-file-table><!--container--><!--ng-container--></main><!--container--></div></div><div _ngcontent-ng-c3342727180="" class="clipboard-container"><app-clipboard _ngcontent-ng-c3342727180="" _nghost-ng-c450165409="" ngh="6"><div _ngcontent-ng-c450165409="" class="clipboard-wrapper"><div _ngcontent-ng-c450165409="" class="clipboard-icon-wrapper" style="right: 20px; bottom: 20px;" jsaction="mousedown:;click:;"><div _ngcontent-ng-c450165409="" class="mat-mdc-tooltip-trigger clipboard-icon-button" ng-reflect-message="Clipboard (0 items)"><mat-icon _ngcontent-ng-c450165409="" role="img" class="mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color" aria-hidden="true" data-mat-icon-type="font" ngh="0">assignment</mat-icon><!--bindings={
  "ng-reflect-ng-if": "false"
