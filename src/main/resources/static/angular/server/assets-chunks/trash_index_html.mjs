...
.trash-container[_ngcontent-ng-c2581499443] {
  max-width: 1200px;
  margin: 0 auto;
  padding: 24px;
}
.trash-header[_ngcontent-ng-c2581499443] {
  display: flex;
  justify-content: space-between;
...
.header-left[_ngcontent-ng-c2581499443]   h1[_ngcontent-ng-c2581499443] {
  margin: 0 0 4px 0;
  font-size: 28px;
  color: #212529;
}
.subtitle[_ngcontent-ng-c2581499443] {
  margin: 0;
  color: #6c757d;
  font-size: 14px;
}
.header-actions[_ngcontent-ng-c2581499443] {
  display: flex;
  gap: 12px;
}
.btn[_ngcontent-ng-c2581499443] {
  display: inline-flex;
  align-items: center;
  gap: 6px;
  padding: 10px 18px;
...
.btn[_ngcontent-ng-c2581499443]:disabled {
  opacity: 0.6;
  cursor: not-allowed;
}
.btn-primary[_ngcontent-ng-c2581499443] {
  background: #0d6efd;
  color: white;
}
.btn-primary[_ngcontent-ng-c2581499443]:hover:not(:disabled) {
  background: #0b5ed7;
}
.btn-secondary[_ngcontent-ng-c2581499443] {
  background: #6c757d;
  color: white;
}
.btn-secondary[_ngcontent-ng-c2581499443]:hover:not(:disabled) {
  background: #5c636a;
}
.btn-danger[_ngcontent-ng-c2581499443] {
  background: #dc3545;
  color: white;
}
.btn-danger[_ngcontent-ng-c2581499443]:hover:not(:disabled) {
  background: #bb2d3b;
}
.btn-sm[_ngcontent-ng-c2581499443] {
  padding: 6px 12px;
  font-size: 13px;
}
.icon[_ngcontent-ng-c2581499443] {
  font-size: 14px;
}
.message-toast[_ngcontent-ng-c2581499443] {
  position: fixed;
  top: 20px;
  right: 20px;
  padding: 12px 20px;
  ...
  font-weight: 500;
  z-index: 1000;
  animation: _ngcontent-ng-c2581499443_slideIn 0.3s ease;
}
.message-toast.success[_ngcontent-ng-c2581499443] {
  background: #d1e7dd;
  color: #0f5132;
  border: 1px solid #badbcc;
}
.message-toast.error[_ngcontent-ng-c2581499443] {
  background: #f8d7da;
  color: #842029;
  border: 1px solid #f5c2c7;
}
@keyframes _ngcontent-ng-c2581499443_slideIn {
  from {
...
.loading-container[_ngcontent-ng-c2581499443] {
  display: flex;
  flex-direction: column;
  align-items: center;
  padding: 60px 20px;
...
.loading-spinner[_ngcontent-ng-c2581499443] {
  width: 40px;
  height: 40px;
  border: 3px solid #e9ecef;
  border-top-color: #0d6efd;
  border-radius: 50%;
  animation: _ngcontent-ng-c2581499443_spin 1s linear infinite;
  margin-bottom: 16px;
}
@keyframes _ngcontent-ng-c2581499443_spin {
  to {
    transform: rotate(360deg);
  }
}
.empty-state[_ngcontent-ng-c2581499443] {
  text-align: center;
  padding: 80px 20px;
  background: #f8f9fa;
  border-radius: 12px;
}
.empty-icon[_ngcontent-ng-c2581499443] {
  font-size: 64px;
  margin-bottom: 16px;
}
.empty-state[_ngcontent-ng-c2581499443]   h2[_ngcontent-ng-c2581499443] {
  margin: 0 0 8px 0;
  color: #212529;
  font-size: 24px;
}
.empty-state[_ngcontent-ng-c2581499443]   p[_ngcontent-ng-c2581499443] {
  margin: 0;
  color: #6c757d;
  max-width: 400px;
  margin: 0 auto;
}
.stats-bar[_ngcontent-ng-c2581499443] {
  display: flex;
  gap: 24px;
  padding: 16px 20px;
  background: #f8f9fa;
...
.stat-item[_ngcontent-ng-c2581499443] {
  display: flex;
  flex-direction: column;
  gap: 2px;
}
.stat-value[_ngcontent-ng-c2581499443] {
  font-size: 18px;
  font-weight: 600;
  color: #212529;
}
.stat-value.warning[_ngcontent-ng-c2581499443] {
  color: #fd7e14;
}
.stat-label[_ngcontent-ng-c2581499443] {
  font-size: 12px;
  color: #6c757d;
  text-transform: uppercase;
  letter-spacing: 0.5px;
}
.trash-list[_ngcontent-ng-c2581499443] {
  display: flex;
  flex-direction: column;
  gap: 12px;
}
.trash-item[_ngcontent-ng-c2581499443] {
  display: flex;
  align-items: center;
  gap: 16px;
  padding: 16px 20px;
...
.trash-item[_ngcontent-ng-c2581499443]:hover {
  border-color: #dee2e6;
  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.05);
}
.trash-item.loading[_ngcontent-ng-c2581499443] {
  opacity: 0.7;
  pointer-events: none;
}
.item-icon[_ngcontent-ng-c2581499443] {
  font-size: 32px;
  flex-shrink: 0;
}
.item-details[_ngcontent-ng-c2581499443] {
  flex: 1;
  min-width: 0;
}
.item-name[_ngcontent-ng-c2581499443] {
  font-weight: 600;
  color: #212529;
  margin-bottom: 4px;
  white-space: nowrap;
...
.item-path[_ngcontent-ng-c2581499443] {
  font-size: 13px;
  color: #6c757d;
  margin-bottom: 6px;
  white-space: nowrap;
...
.item-meta[_ngcontent-ng-c2581499443] {
  display: flex;
  flex-wrap: wrap;
  gap: 12px;
  font-size: 12px;
...
.meta-item[_ngcontent-ng-c2581499443] {
  display: inline-flex;
  align-items: center;
}
.source-badge[_ngcontent-ng-c2581499443] {
  padding: 2px 8px;
  border-radius: 4px;
  font-weight: 500;
}
.source-user[_ngcontent-ng-c2581499443] {
  background: #e7f1ff;
  color: #0d6efd;
}
.source-sync[_ngcontent-ng-c2581499443] {
  background: #fff3cd;
  color: #856404;
}
.source-cleanup[_ngcontent-ng-c2581499443] {
  background: #e2e3e5;
  color: #41464b;
}
.expiry[_ngcontent-ng-c2581499443] {
  color: #6c757d;
}
.expiry.warning[_ngcontent-ng-c2581499443] {
  color: #fd7e14;
  font-weight: 600;
}
.item-actions[_ngcontent-ng-c2581499443] {
  display: flex;
  gap: 8px;
  flex-shrink: 0;
}
@media (max-width: 768px) {
  ...
  .header-actions[_ngcontent-ng-c2581499443]   .btn[_ngcontent-ng-c2581499443] {
    flex: 1;
    justify-content: center;
  }
  .stats-bar[_ngcontent-ng-c2581499443] {
  ...
  .item-actions[_ngcontent-ng-c2581499443]   .btn[_ngcontent-ng-c2581499443] {
    flex: 1;
    justify-content: center;
  }
}
/*# sourceMappingURL=/trash.component.css.map */</style></head>
<body class="mat-typography"><!--nghm--><script type="text/javascript" id="ng-event-dispatch-contract">(()=>{function p(t,n,r,o,e,i,f,m){return{eventType:t,event:n,targetElement:r,eic:o,timeStamp:e,eia:i,eirp:f,eiack:m}}function u(t){let n=[],r=e=>{n.push(e)};return{c:t,q:n,et:[],etc:[],d:r,h:e=>{r(p(e.type,e,e.target,t,Date.now()))}}}function s(t,n,r){for(let o=0;o<n.length;o++){let e=n[o];(r?t.etc:t.et).push(e),t.c.addEventListener(e,t.h,r)}}function c(t,n,r,o,e=window){let i=u(t);e._ejsas||(e._ejsas={}),e._ejsas[n]=i,s(i,r),s(i,o,!0)}window.__jsaction_bootstrap=c;})();
</script><script>window.__jsaction_bootstrap(document.body,"ng",["click"],[]);</script>
  <app-root ng-version="19.2.5" ngh="11" ng-server-context="ssg"><router-outlet></router-outlet><app-trash _nghost-ng-c2581499443="" ngh="0"><div _ngcontent-ng-c2581499443="" class="trash-container"><div _ngcontent-ng-c2581499443="" class="trash-header"><div _ngcontent-ng-c2581499443="" class="header-left"><h1 _ngcontent-ng-c2581499443="">Trash</h1><p _ngcontent-ng-c2581499443="" class="subtitle"> 0 files · 0 B · Files auto-delete after 14 days </p><!--bindings={
  "ng-reflect-ng-if": "[object Object]"
}--></div><div _ngcontent-ng-c2581499443="" class="header-actions"><button _ngcontent-ng-c2581499443="" class="btn btn-secondary" jsaction="click:;"><span _ngcontent-ng-c2581499443="" class="icon">↻</span> Refresh </button><button _ngcontent-ng-c2581499443="" class="btn btn-danger" disabled="" jsaction="click:;"><span _ngcontent-ng-c2581499443="" class="icon">🗑</span> Empty Trash </button></div></div><!--bindings={
  "ng-reflect-ng-if": null
}--><!--bindings={
  "ng-reflect-ng-if": "false"
}--><div _ngcontent-ng-c2581499443="" class="empty-state"><div _ngcontent-ng-c2581499443="" class="empty-icon">🗑️</div><h2 _ngcontent-ng-c2581499443="">Trash is empty</h2><p _ngcontent-ng-c2581499443="">Deleted files will appear here for 14 days before being permanently removed.</p></div><!--bindings={
  "ng-reflect-ng-if": "true"
}--><!--bindings={
  "ng-reflect-ng-if": "false"
}--><!--bindings={
  "ng-reflect-ng-if": "false"
}--></div></app-trash><!--container--><app-print-layout ngh="1"><!--container--></app-print-layout><app-global-message _nghost-ng-c4038518790="" ngh="2"><!--container--></app-global-message><app-global-context-menu ngh="3"><!--container--></app-global-context-menu><app-qr-scanner _nghost-ng-c3289982237="" ngh="4"><!--container--></app-qr-scanner><app-brady-printer-manager _nghost-ng-c3185598614="" ngh="5"><!--container--></app-brady-printer-manager><app-engraver-manager _nghost-ng-c585854076="" ngh="6"><!--container--></app-engraver-manager><app-wizard-dialog _nghost-ng-c2307177025="" ngh="7"><!--container--></app-wizard-dialog><app-comments-dialog _nghost-ng-c1372848867="" ngh="8"><!--container--></app-comments-dialog><app-qa-dialog _nghost-ng-c1416530472="" ngh="10"><app-popup-projection _ngcontent-ng-c1416530472="" size="medium" _nghost-ng-c4000021521="" ng-reflect-size="medium" ng-reflect-is-open="false" ng-reflect-title="Help Information" ngh="9"><!--container--></app-popup-projection></app-qa-dialog></app-root>
