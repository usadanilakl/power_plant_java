...
.home-container[_ngcontent-ng-c4258154757] {
  padding: 2rem;
  max-width: 1200px;
  margin: 0 auto;
}
.home-header[_ngcontent-ng-c4258154757] {
  text-align: center;
  margin-bottom: 2.5rem;
}
.home-header[_ngcontent-ng-c4258154757]   h1[_ngcontent-ng-c4258154757] {
  margin: 0 0 0.5rem 0;
  font-size: 2rem;
  font-weight: 600;
  color: var(--text-primary, #1a1a1a);
}
.home-header[_ngcontent-ng-c4258154757]   p[_ngcontent-ng-c4258154757] {
  margin: 0;
  font-size: 1.1rem;
  color: var(--text-secondary, #666);
}
.navigation-grid[_ngcontent-ng-c4258154757] {
  display: grid;
...
.dark-mode[_nghost-ng-c4258154757]   .home-header[_ngcontent-ng-c4258154757]   h1[_ngcontent-ng-c4258154757], .dark-mode   [_nghost-ng-c4258154757]   .home-header[_ngcontent-ng-c4258154757]   h1[_ngcontent-ng-c4258154757] {
  color: var(--text-primary-dark, #f0f0f0);
}
.dark-mode[_nghost-ng-c4258154757]   .home-header[_ngcontent-ng-c4258154757]   p[_ngcontent-ng-c4258154757], .dark-mode   [_nghost-ng-c4258154757]   .home-header[_ngcontent-ng-c4258154757]   p[_ngcontent-ng-c4258154757] {
  color: var(--text-secondary-dark, #aaa);
}
/*# sourceMappingURL=/home.component.css.map */</style><style ng-app-id="ng">
...
.welcome-overlay[_ngcontent-ng-c615397806] {
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
  ...
  justify-content: center;
  z-index: 10000;
  animation: _ngcontent-ng-c615397806_fadeIn 0.3s ease;
}
@keyframes _ngcontent-ng-c615397806_fadeIn {
  from {
    opacity: 0;
  }
  to {
...
.welcome-dialog[_ngcontent-ng-c615397806] {
  ...
  animation: _ngcontent-ng-c615397806_slideUp 0.3s ease;
  position: relative;
}
.close-btn[_ngcontent-ng-c615397806] {
  position: absolute;
  top: 8px;
  right: 8px;
  background: none;
...
.close-btn[_ngcontent-ng-c615397806]:hover {
  background-color: var(--surface-hover, rgba(0, 0, 0, 0.08));
  color: var(--text-primary, #333333);
}
.close-btn[_ngcontent-ng-c615397806]   mat-icon[_ngcontent-ng-c615397806] {
  font-size: 20px;
  width: 20px;
  height: 20px;
}
@keyframes _ngcontent-ng-c615397806_slideUp {
  from {
...
.welcome-header[_ngcontent-ng-c615397806] {
  display: flex;
  align-items: center;
  gap: 12px;
  margin-bottom: 20px;
}
.welcome-icon[_ngcontent-ng-c615397806] {
  font-size: 32px;
  width: 32px;
  height: 32px;
  color: var(--primary-color, #1976d2);
}
.welcome-header[_ngcontent-ng-c615397806]   h2[_ngcontent-ng-c615397806] {
  margin: 0;
  font-size: 20px;
  font-weight: 600;
  color: var(--text-primary, #333333);
}
.welcome-content[_ngcontent-ng-c615397806] {
  margin-bottom: 24px;
}
.welcome-content[_ngcontent-ng-c615397806]   p[_ngcontent-ng-c615397806] {
  margin: 0 0 12px;
  color: var(--text-secondary, #666666);
  line-height: 1.5;
}
.hint[_ngcontent-ng-c615397806] {
  display: flex;
  align-items: center;
  gap: 4px;
  font-size: 13px;
...
.inline-icon[_ngcontent-ng-c615397806] {
  font-size: 16px;
  width: 16px;
  height: 16px;
  vertical-align: middle;
}
.welcome-actions[_ngcontent-ng-c615397806] {
  display: flex;
  justify-content: flex-end;
  gap: 12px;
}
.welcome-actions[_ngcontent-ng-c615397806]   button[_ngcontent-ng-c615397806] {
  display: flex;
  align-items: center;
  gap: 4px;
}
/*# sourceMappingURL=/welcome-dialog.component.css.map */</style><style ng-app-id="ng">
...
[_nghost-ng-c3544058537] {
  display: block;
  height: 100%;
}
.group-card[_ngcontent-ng-c3544058537] {
...
.group-card[_ngcontent-ng-c3544058537]:hover {
  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1);
  border-color: var(--card-color);
}
.card-main[_ngcontent-ng-c3544058537] {
  display: flex;
  align-items: center;
  gap: 1rem;
  padding: 1.25rem;
...
.card-main[_ngcontent-ng-c3544058537]:hover   .card-icon[_ngcontent-ng-c3544058537] {
  background: var(--card-color);
  color: white;
}
.card-main[_ngcontent-ng-c3544058537]:hover   .card-arrow[_ngcontent-ng-c3544058537] {
  opacity: 1;
  transform: translateX(0);
}
.card-icon[_ngcontent-ng-c3544058537] {
  display: flex;
  align-items: center;
  justify-content: center;
  width: 48px;
...
.card-icon[_ngcontent-ng-c3544058537]   .material-icons[_ngcontent-ng-c3544058537] {
  font-size: 24px;
}
.card-content[_ngcontent-ng-c3544058537] {
  flex: 1;
  min-width: 0;
}
.card-title[_ngcontent-ng-c3544058537] {
  margin: 0 0 0.25rem 0;
  font-size: 1rem;
  font-weight: 600;
  color: var(--text-primary, #1a1a1a);
}
.card-description[_ngcontent-ng-c3544058537] {
  margin: 0;
  font-size: 0.8rem;
  color: var(--text-secondary, #666);
  line-height: 1.3;
}
.card-arrow[_ngcontent-ng-c3544058537] {
  opacity: 0;
  transform: translateX(-8px);
  transition: all 0.2s ease;
  color: var(--card-color);
}
.card-arrow[_ngcontent-ng-c3544058537]   .material-icons[_ngcontent-ng-c3544058537] {
  font-size: 20px;
}
.card-items[_ngcontent-ng-c3544058537] {
  display: flex;
  flex-wrap: wrap;
  gap: 0.5rem;
  padding: 0.75rem 1rem;
  border-top: 1px solid var(--border-color, #e0e0e0);
  background: var(--items-bg, #fafafa);
  flex: 1;
  align-content: flex-start;
}
.card-item[_ngcontent-ng-c3544058537] {
  display: flex;
  align-items: center;
  gap: 0.35rem;
...
.card-item[_ngcontent-ng-c3544058537]:hover {
  border-color: var(--item-color, var(--card-color));
  background: color-mix(in srgb, var(--item-color, var(--card-color)) 10%, white);
  color: var(--item-color, var(--card-color));
}
.card-item[_ngcontent-ng-c3544058537]   .item-icon[_ngcontent-ng-c3544058537] {
  font-size: 14px;
  color: var(--item-color, var(--card-color));
}
.card-item[_ngcontent-ng-c3544058537]   .item-label[_ngcontent-ng-c3544058537] {
  font-weight: 500;
}
.dark-mode[_nghost-ng-c3544058537]   .group-card[_ngcontent-ng-c3544058537], .dark-mode   [_nghost-ng-c3544058537]   .group-card[_ngcontent-ng-c3544058537] {
  background: var(--card-bg-dark, #2a2a2a);
  border-color: var(--border-color-dark, #404040);
}
.dark-mode[_nghost-ng-c3544058537]   .card-title[_ngcontent-ng-c3544058537], .dark-mode   [_nghost-ng-c3544058537]   .card-title[_ngcontent-ng-c3544058537] {
  color: var(--text-primary-dark, #f0f0f0);
}
.dark-mode[_nghost-ng-c3544058537]   .card-description[_ngcontent-ng-c3544058537], .dark-mode   [_nghost-ng-c3544058537]   .card-description[_ngcontent-ng-c3544058537] {
  color: var(--text-secondary-dark, #aaa);
}
.dark-mode[_nghost-ng-c3544058537]   .card-items[_ngcontent-ng-c3544058537], .dark-mode   [_nghost-ng-c3544058537]   .card-items[_ngcontent-ng-c3544058537] {
  background: var(--items-bg-dark, #252525);
  border-color: var(--border-color-dark, #404040);
}
.dark-mode[_nghost-ng-c3544058537]   .card-item[_ngcontent-ng-c3544058537], .dark-mode   [_nghost-ng-c3544058537]   .card-item[_ngcontent-ng-c3544058537] {
  background: var(--card-bg-dark, #2a2a2a);
  border-color: var(--border-color-dark, #404040);
  color: var(--text-primary-dark, #f0f0f0);
}
.dark-mode[_nghost-ng-c3544058537]   .card-item[_ngcontent-ng-c3544058537]:hover, .dark-mode   [_nghost-ng-c3544058537]   .card-item[_ngcontent-ng-c3544058537]:hover {
  background: color-mix(in srgb, var(--item-color, var(--card-color)) 20%, #2a2a2a);
}
/*# sourceMappingURL=/group-navigation-card.component.css.map */</style></head>
<body class="mat-typography"><!--nghm--><script type="text/javascript" id="ng-event-dispatch-contract">(()=>{function p(t,n,r,o,e,i,f,m){return{eventType:t,event:n,targetElement:r,eic:o,timeStamp:e,eia:i,eirp:f,eiack:m}}function u(t){let n=[],r=e=>{n.push(e)};return{c:t,q:n,et:[],etc:[],d:r,h:e=>{r(p(e.type,e,e.target,t,Date.now()))}}}function s(t,n,r){for(let o=0;o<n.length;o++){let e=n[o];(r?t.etc:t.et).push(e),t.c.addEventListener(e,t.h,r)}}function c(t,n,r,o,e=window){let i=u(t);e._ejsas||(e._ejsas={}),e._ejsas[n]=i,s(i,r),s(i,o,!0)}window.__jsaction_bootstrap=c;})();
  ...
  <app-root ng-version="19.2.5" ngh="27" ng-server-context="ssg"><router-outlet></router-outlet><app-home _nghost-ng-c4258154757="" ngh="16"><app-main-layout _ngcontent-ng-c4258154757="" _nghost-ng-c2755335437="" ngh="9"><div _ngcontent-ng-c2755335437="" class="layout-container"><header _ngcontent-ng-c2755335437="" class="header"><div _ngcontent-ng-c2755335437="" class="header-content"><!--container--><h1 _ngcontent-ng-c2755335437="">Jackson Generation</h1><!--container--><app-router-menu _ngcontent-ng-c4258154757="" _nghost-ng-c3178853866="" ng-reflect-layout="row" ngh="10"><nav _ngcontent-ng-c3178853866="" class="router-menu row" ng-reflect-ng-class="row"><div _ngcontent-ng-c3178853866="" class="menu-container"><ul _ngcontent-ng-c3178853866="" class="primary-menu"><li _ngcontent-ng-c3178853866="" class="home-link"><a _ngcontent-ng-c3178853866="" routerlink="/" ng-reflect-router-link="/" href="/" jsaction="click:;">Home</a></li><li _ngcontent-ng-c3178853866="" class="menu-group-link"><a _ngcontent-ng-c3178853866="" ng-reflect-router-link="/file" href="/file" jsaction="click:;">Files</a></li><li _ngcontent-ng-c3178853866="" class="menu-group-link"><a _ngcontent-ng-c3178853866="" ng-reflect-router-link="/loto" href="/loto" jsaction="click:;">LOTO</a></li><li _ngcontent-ng-c3178853866="" class="menu-group-link"><a _ngcontent-ng-c3178853866="" ng-reflect-router-link="/permit-builder" href="/permit-builder" jsaction="click:;">Permits</a></li><li _ngcontent-ng-c3178853866="" class="menu-group-link"><a _ngcontent-ng-c3178853866="" ng-reflect-router-link="/form-designer" href="/form-designer" jsaction="click:;">Form Designer</a></li><li _ngcontent-ng-c3178853866="" class="menu-group-link"><a _ngcontent-ng-c3178853866="" ng-reflect-router-link="/log" href="/log" jsaction="click:;">Log</a></li><li _ngcontent-ng-c3178853866="" class="menu-group-link"><a _ngcontent-ng-c3178853866="" ng-reflect-router-link="/backup" href="/backup" jsaction="click:;">Admin</a></li><!--container--></ul><!--container--></div><!--container--><!--container--><!--container--></nav></app-router-menu><!--ng-container--></div><div _ngcontent-ng-c2755335437="" class="header-actions"><app-sync-indicator _ngcontent-ng-c2755335437="" _nghost-ng-c2707160083="" ngh="1"><div _ngcontent-ng-c2707160083="" class="sync-indicator-wrapper"><div _ngcontent-ng-c2707160083="" class="mat-mdc-tooltip-trigger sync-indicator state-connecting" ng-reflect-message="Checking..." jsaction="click:;"><mat-icon _ngcontent-ng-c2707160083="" role="img" class="mat-icon notranslate pulse material-icons mat-ligature-font mat-icon-no-color" aria-hidden="true" data-mat-icon-type="font" ngh="0"> cloud_sync </mat-icon><!--container--><!--container--></div><!--container--><!--container--></div></app-sync-indicator><app-guide-trigger _ngcontent-ng-c2755335437="" _nghost-ng-c3916921435="" ngh="4"><button _ngcontent-ng-c3916921435="" mat-icon-button="" mattooltip="Start Guide" class="mat-mdc-menu-trigger mat-mdc-tooltip-trigger guide-trigger-btn mdc-icon-button mat-mdc-icon-button mat-unthemed mat-mdc-button-base" mat-ripple-loader-uninitialized="" mat-ripple-loader-class-name="mat-mdc-button-ripple" mat-ripple-loader-centered="" ng-reflect-message="Start Guide" ng-reflect-menu="[object Object]" aria-haspopup="menu" aria-expanded="false" ngh="2" jsaction="click:;mousedown:;keydown:;"><span class="mat-mdc-button-persistent-ripple mdc-icon-button__ripple"></span><mat-icon _ngcontent-ng-c3916921435="" role="img" class="mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color" aria-hidden="true" data-mat-icon-type="font" ngh="0">auto_fix_high</mat-icon><span class="mat-focus-indicator"></span><span class="mat-mdc-button-touch-target"></span></button><!--container--><mat-menu _ngcontent-ng-c3916921435="" ngh="3"><!--container--></mat-menu><!--container--></app-guide-trigger><app-qa-toggle _ngcontent-ng-c2755335437="" _nghost-ng-c3176921999="" ngh="5"><button _ngcontent-ng-c3176921999="" mat-icon-button="" class="mat-mdc-tooltip-trigger qa-toggle-btn mdc-icon-button mat-mdc-icon-button mat-unthemed mat-mdc-button-base" mat-ripple-loader-uninitialized="" mat-ripple-loader-class-name="mat-mdc-button-ripple" mat-ripple-loader-centered="" ng-reflect-message="Enable Help Mode" ngh="2" jsaction="click:;"><span class="mat-mdc-button-persistent-ripple mdc-icon-button__ripple"></span><mat-icon _ngcontent-ng-c3176921999="" role="img" class="mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color" aria-hidden="true" data-mat-icon-type="font" ngh="0">help_outline</mat-icon><span class="mat-focus-indicator"></span><span class="mat-mdc-button-touch-target"></span></button><!--container--></app-qa-toggle><app-tour-trigger _ngcontent-ng-c2755335437="" _nghost-ng-c1184412316="" ngh="6"><button _ngcontent-ng-c1184412316="" mat-icon-button="" mattooltip="Help &amp; Tours" class="mat-mdc-menu-trigger mat-mdc-tooltip-trigger tour-trigger-btn mdc-icon-button mat-mdc-icon-button mat-unthemed mat-mdc-button-base" mat-ripple-loader-uninitialized="" mat-ripple-loader-class-name="mat-mdc-button-ripple" mat-ripple-loader-centered="" ng-reflect-message="Help &amp; Tours" ng-reflect-menu="[object Object]" aria-haspopup="menu" aria-expanded="false" ngh="2" jsaction="click:;mousedown:;keydown:;"><span class="mat-mdc-button-persistent-ripple mdc-icon-button__ripple"></span><mat-icon _ngcontent-ng-c1184412316="" role="img" class="mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color" aria-hidden="true" data-mat-icon-type="font" ngh="0">help_outline</mat-icon><span class="mat-focus-indicator"></span><span class="mat-mdc-button-touch-target"></span></button><!--container--><mat-menu _ngcontent-ng-c1184412316="" class="" ngh="3"><!--container--></mat-menu></app-tour-trigger><app-theme-toggle _ngcontent-ng-c2755335437="" _nghost-ng-c3074088440="" ngh="7"><button _ngcontent-ng-c3074088440="" class="theme-toggle-button" jsaction="click:;"><span _ngcontent-ng-c3074088440="">🌙</span><!--bindings={
  "ng-reflect-ng-if": "true"
}--><!--bindings={
  "ng-reflect-ng-if": "false"
}--></button></app-theme-toggle></div></header><div _ngcontent-ng-c2755335437="" class="content-wrapper"><!--container--><div _ngcontent-ng-c2755335437="" class="main-and-footer"><main _ngcontent-ng-c2755335437="" class="main-content"><div _ngcontent-ng-c4258154757="" class="home-container"><div _ngcontent-ng-c4258154757="" class="home-header"><h1 _ngcontent-ng-c4258154757="">Power Plant Management</h1><p _ngcontent-ng-c4258154757="">Select a module to get started</p></div><div _ngcontent-ng-c4258154757="" class="navigation-grid"><app-group-navigation-card _ngcontent-ng-c4258154757="" _nghost-ng-c3544058537="" ng-reflect-group="[object Object]" ngh="11"><div _ngcontent-ng-c3544058537="" class="group-card" style="--card-color: #3498db;"><a _ngcontent-ng-c3544058537="" class="card-main" ng-reflect-router-link="/file" href="/file" jsaction="click:;"><div _ngcontent-ng-c3544058537="" class="card-icon"><span _ngcontent-ng-c3544058537="" class="material-icons">folder</span></div><div _ngcontent-ng-c3544058537="" class="card-content"><h3 _ngcontent-ng-c3544058537="" class="card-title">Files</h3><p _ngcontent-ng-c3544058537="" class="card-description">Manage equipment files, tags, and printing</p></div><div _ngcontent-ng-c3544058537="" class="card-arrow"><span _ngcontent-ng-c3544058537="" class="material-icons">chevron_right</span></div></a><div _ngcontent-ng-c3544058537="" class="card-items"><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #3498db;" ng-reflect-router-link="/file" href="/file" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">folder</span><span _ngcontent-ng-c3544058537="" class="item-label">View Files</span></a><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #16a085;" ng-reflect-router-link="/tag-number" href="/tag-number" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">add_circle</span><span _ngcontent-ng-c3544058537="" class="item-label">Create Tag</span></a><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #7f8c8d;" ng-reflect-router-link="/print" href="/print" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">print</span><span _ngcontent-ng-c3544058537="" class="item-label">Print</span></a><!--container--></div></div></app-group-navigation-card><app-group-navigation-card _ngcontent-ng-c4258154757="" _nghost-ng-c3544058537="" ng-reflect-group="[object Object]" ngh="12"><div _ngcontent-ng-c3544058537="" class="group-card" style="--card-color: #e74c3c;"><a _ngcontent-ng-c3544058537="" class="card-main" ng-reflect-router-link="/loto" href="/loto" jsaction="click:;"><div _ngcontent-ng-c3544058537="" class="card-icon"><span _ngcontent-ng-c3544058537="" class="material-icons">lock</span></div><div _ngcontent-ng-c3544058537="" class="card-content"><h3 _ngcontent-ng-c3544058537="" class="card-title">LOTO</h3><p _ngcontent-ng-c3544058537="" class="card-description">Lockout/Tagout procedures and safety protocols</p></div><div _ngcontent-ng-c3544058537="" class="card-arrow"><span _ngcontent-ng-c3544058537="" class="material-icons">chevron_right</span></div></a><div _ngcontent-ng-c3544058537="" class="card-items"><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #e74c3c;" ng-reflect-router-link="/loto" href="/loto" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">lock</span><span _ngcontent-ng-c3544058537="" class="item-label">LOTO</span></a><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #9b59b6;" ng-reflect-router-link="/loto-points" href="/loto-points" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">location_on</span><span _ngcontent-ng-c3544058537="" class="item-label">Loto Points</span></a><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #e67e22;" ng-reflect-router-link="/loto-standard" href="/loto-standard" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">description</span><span _ngcontent-ng-c3544058537="" class="item-label">LOTO Standards</span></a><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #1abc9c;" ng-reflect-router-link="/loto-builder" href="/loto-builder" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">build</span><span _ngcontent-ng-c3544058537="" class="item-label">Loto Builder</span></a><!--container--></div></div></app-group-navigation-card><app-group-navigation-card _ngcontent-ng-c4258154757="" _nghost-ng-c3544058537="" ng-reflect-group="[object Object]" ngh="13"><div _ngcontent-ng-c3544058537="" class="group-card" style="--card-color: #f39c12;"><a _ngcontent-ng-c3544058537="" class="card-main" ng-reflect-router-link="/permit-builder" href="/permit-builder" jsaction="click:;"><div _ngcontent-ng-c3544058537="" class="card-icon"><span _ngcontent-ng-c3544058537="" class="material-icons">assignment</span></div><div _ngcontent-ng-c3544058537="" class="card-content"><h3 _ngcontent-ng-c3544058537="" class="card-title">Permits</h3><p _ngcontent-ng-c3544058537="" class="card-description">Work permits, scheduling, and authorizations</p></div><div _ngcontent-ng-c3544058537="" class="card-arrow"><span _ngcontent-ng-c3544058537="" class="material-icons">chevron_right</span></div></a><div _ngcontent-ng-c3544058537="" class="card-items"><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #f39c12;" ng-reflect-router-link="/permit-builder/daily-packages" href="/permit-builder/daily-packages" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">event_note</span><span _ngcontent-ng-c3544058537="" class="item-label">Daily Packages</span></a><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #e67e22;" ng-reflect-router-link="/permit-builder/work-requests" href="/permit-builder/work-requests" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">request_page</span><span _ngcontent-ng-c3544058537="" class="item-label">Work Requests</span></a><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #d35400;" ng-reflect-router-link="/permit-builder/jobs" href="/permit-builder/jobs" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">work</span><span _ngcontent-ng-c3544058537="" class="item-label">Job Logs</span></a><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #27ae60;" ng-reflect-router-link="/permit-builder/safe-works" href="/permit-builder/safe-works" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">health_and_safety</span><span _ngcontent-ng-c3544058537="" class="item-label">Safe Works</span></a><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #e74c3c;" ng-reflect-router-link="/permit-builder/hot-works" href="/permit-builder/hot-works" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">local_fire_department</span><span _ngcontent-ng-c3544058537="" class="item-label">Hot Works</span></a><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #8e44ad;" ng-reflect-router-link="/permit-builder/confined-space" href="/permit-builder/confined-spaces" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">sensor_door</span><span _ngcontent-ng-c3544058537="" class="item-label">Confined Spaces</span></a><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #2ecc71;" ng-reflect-router-link="/scheduler" href="/scheduler" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">schedule</span><span _ngcontent-ng-c3544058537="" class="item-label">Scheduler</span></a><!--container--></div></div></app-group-navigation-card><app-group-navigation-card _ngcontent-ng-c4258154757="" _nghost-ng-c3544058537="" ng-reflect-group="[object Object]" ngh="14"><div _ngcontent-ng-c3544058537="" class="group-card" style="--card-color: #34495e;"><a _ngcontent-ng-c3544058537="" class="card-main" ng-reflect-router-link="/form-designer" href="/form-designer" jsaction="click:;"><div _ngcontent-ng-c3544058537="" class="card-icon"><span _ngcontent-ng-c3544058537="" class="material-icons">edit_document</span></div><div _ngcontent-ng-c3544058537="" class="card-content"><h3 _ngcontent-ng-c3544058537="" class="card-title">Form Designer</h3><p _ngcontent-ng-c3544058537="" class="card-description">Design and preview printable forms</p></div><div _ngcontent-ng-c3544058537="" class="card-arrow"><span _ngcontent-ng-c3544058537="" class="material-icons">chevron_right</span></div></a><div _ngcontent-ng-c3544058537="" class="card-items"><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #34495e;" ng-reflect-router-link="/form-designer" href="/form-designer" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">edit_document</span><span _ngcontent-ng-c3544058537="" class="item-label">Form Designer</span></a><!--container--></div></div></app-group-navigation-card><app-group-navigation-card _ngcontent-ng-c4258154757="" _nghost-ng-c3544058537="" ng-reflect-group="[object Object]" ngh="14"><div _ngcontent-ng-c3544058537="" class="group-card" style="--card-color: #607d8b;"><a _ngcontent-ng-c3544058537="" class="card-main" ng-reflect-router-link="/log" href="/log" jsaction="click:;"><div _ngcontent-ng-c3544058537="" class="card-icon"><span _ngcontent-ng-c3544058537="" class="material-icons">forum</span></div><div _ngcontent-ng-c3544058537="" class="card-content"><h3 _ngcontent-ng-c3544058537="" class="card-title">Log</h3><p _ngcontent-ng-c3544058537="" class="card-description">View all system comments and activity</p></div><div _ngcontent-ng-c3544058537="" class="card-arrow"><span _ngcontent-ng-c3544058537="" class="material-icons">chevron_right</span></div></a><div _ngcontent-ng-c3544058537="" class="card-items"><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #607d8b;" ng-reflect-router-link="/log" href="/log" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">forum</span><span _ngcontent-ng-c3544058537="" class="item-label">System Log</span></a><!--container--></div></div></app-group-navigation-card><app-group-navigation-card _ngcontent-ng-c4258154757="" _nghost-ng-c3544058537="" ng-reflect-group="[object Object]" ngh="12"><div _ngcontent-ng-c3544058537="" class="group-card" style="--card-color: #c0392b;"><a _ngcontent-ng-c3544058537="" class="card-main" ng-reflect-router-link="/backup" href="/backup" jsaction="click:;"><div _ngcontent-ng-c3544058537="" class="card-icon"><span _ngcontent-ng-c3544058537="" class="material-icons">admin_panel_settings</span></div><div _ngcontent-ng-c3544058537="" class="card-content"><h3 _ngcontent-ng-c3544058537="" class="card-title">Admin</h3><p _ngcontent-ng-c3544058537="" class="card-description">System administration and synchronization</p></div><div _ngcontent-ng-c3544058537="" class="card-arrow"><span _ngcontent-ng-c3544058537="" class="material-icons">chevron_right</span></div></a><div _ngcontent-ng-c3544058537="" class="card-items"><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #8e44ad;" ng-reflect-router-link="/backup" href="/backup" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">backup</span><span _ngcontent-ng-c3544058537="" class="item-label">Backup</span></a><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #27ae60;" ng-reflect-router-link="/sync" href="/sync" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">sync</span><span _ngcontent-ng-c3544058537="" class="item-label">Sync Dashboard</span></a><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #2980b9;" ng-reflect-router-link="/full-sync-to-server" href="/full-sync-to-server" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">cloud_upload</span><span _ngcontent-ng-c3544058537="" class="item-label">Full Sync to Server</span></a><a _ngcontent-ng-c3544058537="" class="card-item" style="--item-color: #c0392b;" ng-reflect-router-link="/admin" href="/admin" jsaction="click:;"><span _ngcontent-ng-c3544058537="" class="material-icons item-icon">admin_panel_settings</span><span _ngcontent-ng-c3544058537="" class="item-label">Admin</span></a><!--container--></div></div></app-group-navigation-card><!--container--></div></div><!--ng-container--></main><!--container--></div></div><div _ngcontent-ng-c2755335437="" class="clipboard-container"><app-clipboard _ngcontent-ng-c2755335437="" _nghost-ng-c450165409="" ngh="8"><div _ngcontent-ng-c450165409="" class="clipboard-wrapper"><div _ngcontent-ng-c450165409="" class="clipboard-icon-wrapper" style="right: 20px; bottom: 20px;" jsaction="mousedown:;click:;"><div _ngcontent-ng-c450165409="" class="mat-mdc-tooltip-trigger clipboard-icon-button" ng-reflect-message="Clipboard (0 items)"><mat-icon _ngcontent-ng-c450165409="" role="img" class="mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color" aria-hidden="true" data-mat-icon-type="font" ngh="0">assignment</mat-icon><!--bindings={
  "ng-reflect-ng-if": "false"
  ...
  "ng-reflect-ng-if": "false"
}--></div></app-clipboard></div></div></app-main-layout><app-welcome-dialog _ngcontent-ng-c4258154757="" _nghost-ng-c615397806="" ngh="15"><!--container--></app-welcome-dialog></app-home><!--container--><app-print-layout ngh="17"><!--container--></app-print-layout><app-global-message _nghost-ng-c4038518790="" ngh="18"><!--container--></app-global-message><app-global-context-menu ngh="19"><!--container--></app-global-context-menu><app-qr-scanner _nghost-ng-c3289982237="" ngh="20"><!--container--></app-qr-scanner><app-brady-printer-manager _nghost-ng-c3185598614="" ngh="21"><!--container--></app-brady-printer-manager><app-engraver-manager _nghost-ng-c585854076="" ngh="22"><!--container--></app-engraver-manager><app-wizard-dialog _nghost-ng-c2307177025="" ngh="23"><!--container--></app-wizard-dialog><app-comments-dialog _nghost-ng-c1372848867="" ngh="24"><!--container--></app-comments-dialog><app-qa-dialog _nghost-ng-c1416530472="" ngh="26"><app-popup-projection _ngcontent-ng-c1416530472="" size="medium" _nghost-ng-c4000021521="" ng-reflect-size="medium" ng-reflect-is-open="false" ng-reflect-title="Help Information" ngh="25"><!--container--></app-popup-projection></app-qa-dialog></app-root>
