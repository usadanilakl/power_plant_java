...
.admin-container[_ngcontent-ng-c1204739824] {
  max-width: 1200px;
  margin: 0 auto;
  padding: 20px;
}
.full-width-header[_ngcontent-ng-c1204739824] {
  margin-bottom: 20px;
}
h2[_ngcontent-ng-c1204739824] {
  color: #333;
  margin-bottom: 30px;
  border-bottom: 2px solid #007bff;
  padding-bottom: 10px;
}
.admin-section[_ngcontent-ng-c1204739824] {
  background: #fff;
...
.admin-section[_ngcontent-ng-c1204739824]   h3[_ngcontent-ng-c1204739824] {
  color: #333;
  margin-top: 0;
  margin-bottom: 10px;
}
.description[_ngcontent-ng-c1204739824] {
  color: #666;
  font-size: 14px;
  margin-bottom: 15px;
  line-height: 1.5;
}
.button-group[_ngcontent-ng-c1204739824] {
  display: flex;
  gap: 10px;
  margin-bottom: 15px;
}
button[_ngcontent-ng-c1204739824] {
  padding: 10px 20px;
  border: none;
  border-radius: 4px;
  cursor: pointer;
...
button[_ngcontent-ng-c1204739824]:disabled {
  opacity: 0.6;
  cursor: not-allowed;
}
button[_ngcontent-ng-c1204739824]:not(.action-btn):not(.toggle-btn) {
  background-color: #6c757d;
  color: white;
}
button[_ngcontent-ng-c1204739824]:not(.action-btn):not(.toggle-btn):hover:not(:disabled) {
  background-color: #5a6268;
}
.action-btn[_ngcontent-ng-c1204739824] {
  background-color: #007bff;
  color: white;
}
.action-btn[_ngcontent-ng-c1204739824]:hover:not(:disabled) {
  background-color: #0056b3;
}
.toggle-btn[_ngcontent-ng-c1204739824] {
  background-color: #e9ecef;
  color: #333;
  padding: 8px 15px;
  font-size: 13px;
}
.toggle-btn[_ngcontent-ng-c1204739824]:hover {
  background-color: #dee2e6;
}
.error[_ngcontent-ng-c1204739824] {
...
.result[_ngcontent-ng-c1204739824] {
  background-color: #f8f9fa;
  padding: 15px;
  border-radius: 4px;
  margin-top: 10px;
}
.result-summary[_ngcontent-ng-c1204739824] {
  display: flex;
  flex-wrap: wrap;
  gap: 10px;
  margin-bottom: 15px;
}
.badge[_ngcontent-ng-c1204739824] {
  display: inline-block;
  padding: 5px 12px;
  border-radius: 20px;
  font-size: 13px;
...
.badge.success[_ngcontent-ng-c1204739824] {
  background-color: #d4edda;
  color: #155724;
}
.badge.warning[_ngcontent-ng-c1204739824] {
  background-color: #fff3cd;
  color: #856404;
}
.badge.info[_ngcontent-ng-c1204739824] {
  background-color: #cce5ff;
  color: #004085;
}
.details-section[_ngcontent-ng-c1204739824] {
  margin-top: 15px;
}
.details-list[_ngcontent-ng-c1204739824] {
  margin-top: 10px;
  max-height: 400px;
  overflow-y: auto;
}
table[_ngcontent-ng-c1204739824] {
  width: 100%;
  border-collapse: collapse;
  font-size: 13px;
}
table[_ngcontent-ng-c1204739824]   th[_ngcontent-ng-c1204739824], 
table[_ngcontent-ng-c1204739824]   td[_ngcontent-ng-c1204739824] {
  text-align: left;
  padding: 8px 12px;
...
table[_ngcontent-ng-c1204739824]   tr[_ngcontent-ng-c1204739824]:hover {
  background-color: #f8f9fa;
}
table[_ngcontent-ng-c1204739824]   td[_ngcontent-ng-c1204739824] {
  word-break: break-word;
}
.nav-btn[_ngcontent-ng-c1204739824] {
  display: inline-block;
  padding: 10px 20px;
  border: none;
  border-radius: 4px;
...
.nav-btn[_ngcontent-ng-c1204739824]:hover {
  background-color: #218838;
}
.quick-links[_ngcontent-ng-c1204739824] {
  background:
    linear-gradient(
      135deg,
      #f8f9fa 0%,
...
/*# sourceMappingURL=/admin-functionalities.component.css.map */</style><style ng-app-id="ng">
