...
public class HtPanelMapper implements BaseMapper {
    ...
    public HtPanelMapper(ModelMapper modelMapper, HtPanelService htPanelService, HtBreakerService htBreakerService) {
    ...
    public HtPanel convertToDto(HtPanelDto dto){
        if(dto!=null){
            HtPanel entity = new HtPanel();
