...
public class LotoService extends BasePermitServiceImpl<Loto, LotoDto>{
    ...
    public LotoService(@Qualifier("lotoRepo") BasePermitRepo<Loto> repository, PermitNumbersService permitNumbersService, FilterService<Loto> filterService, UserDetailsServiceImpl customUserDetails, BasePermitMapper<Loto, LotoDto> permitMapper, LotoRepo lotoRepo) {
