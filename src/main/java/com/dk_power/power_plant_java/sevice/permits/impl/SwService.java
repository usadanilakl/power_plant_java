...
public class SwService extends BasePermitServiceImpl<Sw, SwDto>{
    ...
    public SwService(@Qualifier("swRepo") BasePermitRepo<Sw> repository, PermitNumbersService permitNumbersService, FilterService<Sw> filterService, UserDetailsServiceImpl customUserDetails, BaseSwRepo swRepo) {
