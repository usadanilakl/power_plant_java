...
public class EqBreakerServiceImpl implements EqBreakerService {
    ...
    public EqBreakerServiceImpl(@Lazy EqBreakerMapper eqBreakerMapper, EqBreakerRepo eqBreakerRepo, SessionFactory sessionFactory, @Lazy ElectricalPanelService electricalPanelService, @Lazy EquipmentService equipmentService) {
