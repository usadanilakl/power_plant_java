...
public interface MaximoFormSubmissionRepo extends BaseRepository<MaximoFormSubmission> {
    ...
    /** All submissions in a status, newest completion first — the audit view groups these by pmnum. */
    List<MaximoFormSubmission> findByStatusOrderBySubmittedAtDesc(MaximoFormStatus status);
}
