...
@Component({
  ...
  styles: [`
    ...
    .rt-header h2 { margin: 0 0 4px; }
    .rt-subtitle { color: #888; font-size: 13px; margin: 0; max-width: 620px; }
    .rt-note { color: #999; font-size: 13px; }
    .rt-empty { text-align: center; padding: 48px 0; }
    ...
    .rt-btn-primary { background: #2196F3; color: #fff; }
    .rt-table { width: 100%; border-collapse: collapse; margin-top: 16px; }
    .rt-table th { text-align: left; padding: 8px 10px; background: #f3f4f6; color: #4b5563;
      font-size: 11px; text-transform: uppercase; letter-spacing: 0.05em; border-bottom: 1px solid #e4e4e7; }
    .rt-table td { padding: 10px; border-bottom: 1px solid #f0f0f0; }
    .rt-row { cursor: pointer; }
    .rt-row:hover { background: #f0f8ff; }
    .rt-name { font-weight: 600; color: #1f2937; }
