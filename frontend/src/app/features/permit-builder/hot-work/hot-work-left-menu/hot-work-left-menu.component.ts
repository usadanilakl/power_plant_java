...
@Component({
  selector: 'app-hot-work-left-menu',
  standalone: true,
  imports: [CommonModule, RfToggleMenuComponent],
  templateUrl: './hot-work-left-menu.component.html',
  styleUrl: './hot-work-left-menu.component.css',
})
export class HotWorkLeftMenuComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.currentHotWorkService.allActiveHotWorks$.pipe(
  ...
  onItemClick(item: NestedItem): void {
    ...
    this.currentHotWorkService.setCurrentHotWork(Number(item.id));
  }
