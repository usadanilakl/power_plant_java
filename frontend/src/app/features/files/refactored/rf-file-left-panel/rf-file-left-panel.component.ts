...
import { RfFileNavTableComponent } from './rf-file-nav-table.component';

export type FileDisplayMode = 'table' | 'toggle-menu';

/**
 * Reusable file left panel with two display modes: toggle-menu (tree) and table.
 *
 ...
 */
@Component({
  selector: 'app-rf-file-left-panel',
  standalone: true,
  imports: [CommonModule, MatIconModule, RfFileLeftMenuComponent, RfFileNavTableComponent],
  template: `
    <div class="left-panel-wrapper">
      ...
      <div class="panel-content">
        @if (currentMode() === 'toggle-menu') {
          ...
          <app-rf-file-nav-table
            [tableId]="'file-left-panel-table'"
  ...
  styles: [`
    ...
    .panel-content app-rf-file-left-menu,
    .panel-content app-rf-file-nav-table {
      width: 100%;
      height: 100%;
      display: flex;
      flex-direction: column;
