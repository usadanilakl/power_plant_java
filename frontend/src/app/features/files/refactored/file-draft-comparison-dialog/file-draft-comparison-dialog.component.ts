...
@Component({
  selector: 'app-file-draft-comparison-dialog',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './file-draft-comparison-dialog.component.html',
  styleUrls: ['./file-draft-comparison-dialog.component.css']
})
export class FileDraftComparisonDialogComponent {
  // Inputs - direct entity comparison
  serverVersion = input.required<FileDto>(); // Version from server
  draftVersion = input.required<FileDto>(); // Version from localStorage/draft
