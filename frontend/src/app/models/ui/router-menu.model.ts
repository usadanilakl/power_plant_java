...
export const GROUPED_MAIN_MENU: GroupedRouterMenu = [
    ...
    },
    {
        ...
        items: [
            ...
            { route: '/red-tag-standards', label: 'Red Tag Standards', icon: 'sell', iconColor: '#EF5350' },
            ...
            { route: '/loto-board', label: 'LOTO Board', icon: 'dashboard', iconColor: '#EC407A' },
            { route: '/loto-usage', label: 'LOTO Usage', icon: 'monitor_heart', iconColor: '#26C6DA' },
    ...
    },
    {
        ...
        items: [
            ...
            { route: '/permit-builder/air-monitoring', label: 'Air Monitoring', icon: 'air', iconColor: '#26C6DA' },
    ...
    },
    {
        ...
        items: [
            ...
            { route: '/plant/hierarchy', label: 'Plant Locations', icon: 'account_tree', iconColor: '#42A5F5' },
            ...
            { route: '/maximo/wo-questions', label: 'WO Questions', icon: 'forum', iconColor: '#2980b9' },
...
export const PERMIT_BUILDER_NAV_MENU_ITEMS = [
    ...
    { label: 'Air Monitoring', route: './air-monitoring' },
