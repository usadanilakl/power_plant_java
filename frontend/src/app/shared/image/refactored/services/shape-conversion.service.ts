...
import { RfImageShape, RfRectangleShape } from '../models/fr-shape.model';
...
export class ShapeConversionService {
   ...
   */
  convertImageToRectangle(imageShape: RfImageShape): RfRectangleShape {
  ...
  async updateImageForShape(
    ...
    return new Promise((resolve, reject) => {
      ...
      reader.onload = (e) => {
        ...
        img.onload = () => {
          const updatedShape: RfImageShape = {
            ...imageShape,
            imageUrl: URL.createObjectURL(file),
            imageData: imageData,
          };
