...
PATTERNS = [
    ...
    # ---- LOTO information form (post-Continue) ----------------------------
    ("LOTO_DETAILS_DIALOG_TITLE", "loto details dialog.png",
     "loto-details/dialog-title.png", (1010, 364, 1135, 383)),
    ("LOTO_DETAILS_LOCK_BOX_LABEL", "loto details dialog.png",
     "loto-details/lock-box-label.png", (1308, 430, 1422, 449)),
    ("LOTO_DETAILS_OWNER_LABEL", "loto details dialog.png",
     "loto-details/owner-label.png", (1050, 517, 1324, 537)),
    ("LOTO_DETAILS_WHY_LABEL", "loto details dialog.png",
     "loto-details/why-label.png", (1030, 571, 1214, 590)),
    ("LOTO_DETAILS_REQUESTED_BY_HEADER", "loto details dialog.png",
     "loto-details/requested-by-header.png", (1016, 639, 1092, 657)),
    ("LOTO_DETAILS_OK_BUTTON", "loto details dialog.png",
     "loto-details/ok-button.png", (1398, 977, 1500, 1010)),
    ("LOTO_SUBMISSION_WARNING_OK", "loto details dialog submission error.png",
    ...
    ("SW_ISSUE_NO_TEMPLATE_BUTTON", "permits/issue permit with not template.png",
     "safe-work/issue-no-template-button.png", (0, 0, 429, 103)),
    ("SW_ZOOM_OUT_BUTTON", "permits/zoom-out-button.png",
     "safe-work/zoom-out-button.png", (0, 0, 88, 88)),
    ("SW_SAVE_BUTTON", "permits/default sw form view.png",
     "safe-work/save-button.png", (6, 66, 44, 98)),
    ("SW_ERROR_RECORD_IN_USE", "permits/ERROR_RECORD_IN_USE.png",
     "safe-work/error-record-in-use.png", (0, 0, 165, 118)),
    ("SW_PERMIT_NUMBER_COLUMN", "permits/sw list ungrouped.png",
     "safe-work/permit-number-column.png", (188, 142, 282, 164)),
    ("SW_HAZARDS_HEADER", "permits/zoomed out sw form view.png",
     "safe-work/hazards-header.png", (1130, 382, 1390, 399)),
    ("SW_PERMITS_HEADER", "permits/zoomed out sw form view.png",
     "safe-work/permits-header.png", (1110, 661, 1415, 678)),
    ("SW_PPE_HEADER", "permits/zoomed out sw form view.png",
     "safe-work/ppe-header.png", (1128, 812, 1414, 832)),
    ("SW_DATE_ISSUED_LABEL", "permits/zoomed out sw form view.png",
     "safe-work/date-issued-label.png", (838, 266, 922, 285)),
    ("SW_LOCATION_LABEL", "permits/zoomed out sw form view.png",
     "safe-work/location-label.png", (838, 304, 1027, 323)),
    ("SW_DESCRIPTION_LABEL", "permits/zoomed out sw form view.png",
     "safe-work/description-label.png", (840, 333, 1087, 348)),
    ("SW_SPECIAL_INSTRUCTIONS_LABEL", "permits/zoomed out sw form view.png",
